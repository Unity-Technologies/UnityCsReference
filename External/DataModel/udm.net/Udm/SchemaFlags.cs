...
namespace Unity.DataModel
{
    ...
    internal struct SchemaFlags
    {
        ...
        internal static readonly SchemaFlags IsVector =                   new SchemaFlags { data = 1 << 4 };
        internal static readonly SchemaFlags IsMap =                      new SchemaFlags { data = 1 << 5 };
        internal static readonly SchemaFlags InlineTextSerialization =    new SchemaFlags { data = 1 << 6 };
        internal static readonly SchemaFlags IsManaged =                  new SchemaFlags { data = 1 << 7 };
        internal static readonly SchemaFlags IsFixedBuffer =              new SchemaFlags { data = 1 << 8 };
