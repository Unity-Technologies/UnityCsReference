...
namespace Unity.DataModel
{
    ...
    internal sealed class UnityUdmInterop : IUdmInterop
    {
        ...
        public unsafe uint udm_xxhash32(byte* data, ulong size)
        {
            return UDM.udm_xxhash32(data, size);
        }

        public unsafe Hash udm_xxh3_128(byte* data, ulong size)
        {
            return UDM.udm_xxh3_128(data, size);
        }
        ...
        public unsafe ulong udm_document_model_get_references_size(IntPtr document_model)
        {
            return UDM.udm_document_model_get_references_size(document_model);
        }

        public unsafe void udm_document_model_set_reference(IntPtr document_model, ReferenceField* field, Reference reference)
        {
            UDM.udm_document_model_set_reference(document_model, field, reference);
        }
        ...
        public void udm_schema_builder_set_as_fixed_buffer(IntPtr schema_builder, int is_fixed_buffer)
        {
            UDM.udm_schema_builder_set_as_fixed_buffer(schema_builder, is_fixed_buffer);
        }

        public void udm_schema_builder_set_as_managed(IntPtr schema_builder, int is_managed)
        {
            UDM.udm_schema_builder_set_as_managed(schema_builder, is_managed);
        }

        public unsafe void udm_schema_builder_set_underlying_type_id(IntPtr schema_builder, UdmTypeId* underlying_type_id)
        {
            UDM.udm_schema_builder_set_underlying_type_id(schema_builder, underlying_type_id);
        }
