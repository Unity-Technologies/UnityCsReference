...
namespace Unity.Scripting.LifecycleManagement.CodeGen
{
    ...
    /// </summary>
    public abstract class ClassAutoCleanup
    {
        public abstract void Cleanup();

        protected ClassAutoCleanup(Type scopeType)
        {
            LifecycleController.Instance.RegisterAutoCleanup(this, scopeType, ScopeTransitionType.Both);
        }

        internal ClassAutoCleanup(Type scopeType, ScopeTransitionType cleanOn)
        {
