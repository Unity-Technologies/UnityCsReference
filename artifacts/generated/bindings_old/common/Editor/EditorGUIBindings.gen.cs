...
public static void DrawTextureAlpha (Rect position, Texture image, ScaleMode scaleMode , float imageAspect ) {
    float mipLevel = -1;
    DrawTextureAlpha ( position, image, scaleMode, imageAspect, mipLevel );
}
...
public static void DrawTextureAlpha(Rect position, Texture image, [uei.DefaultValue("ScaleMode.StretchToFill")]  ScaleMode scaleMode , [uei.DefaultValue("0")]  float imageAspect , [uei.DefaultValue("-1")]  float mipLevel )
        {
...
public static void DrawTextureTransparent(Rect position, Texture image, [uei.DefaultValue("ScaleMode.StretchToFill")]  ScaleMode scaleMode , [uei.DefaultValue("0")]  float imageAspect , [uei.DefaultValue("-1")]  float mipLevel )
        {
...
public static void DrawPreviewTexture(Rect position, Texture image, [uei.DefaultValue("null")]  Material mat , [uei.DefaultValue("ScaleMode.StretchToFill")]  ScaleMode scaleMode , [uei.DefaultValue("0")]  float imageAspect , [uei.DefaultValue("-1")]  float mipLevel )
        {
