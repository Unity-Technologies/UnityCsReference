...
namespace UnityEngine.UIElements
{
    ...
    /// vertex values to map it to the resulting mesh. UI Toolkit stores the texture in an internal atlas. To avoid the texture being displayed incorrectly
    ///  when it's atlassed, remap the UVs inside the <see cref="MeshWriteData.uvRegion"/> rectangle.
