...
namespace UnityEngine.UIElements.UIR
{
    ...
    class MeshGenerator : IMeshGenerator
    {
        ...
        void MakeText(Texture texture, MeshInfo meshInfo, Vector2 offset, bool isSdf, bool isDynamicColor, float sdfScale)
        {
            ...
            if (isSdf)
                m_MeshGenerationContext.entryRecorder.DrawSdfText(vertices, indices, texture, sdfScale);
            else
