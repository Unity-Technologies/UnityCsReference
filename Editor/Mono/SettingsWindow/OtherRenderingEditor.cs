...
namespace UnityEditor
{
    ...
    internal class OtherRenderingEditor : Editor
    {
        ...
        {
            public static readonly GUIContent HaloStrength = L10n.TextContent("Halo Strength", "Controls the visibility of the halo effect around lights in the Scene.", null, null);
            public static readonly GUIContent HaloTexture = L10n.TextContent("Halo Texture", "Specifies the Texture used when drawing the halo effect around lights in the Scene", null, null);
            public static readonly GUIContent FlareStrength = L10n.TextContent("Flare Strength", "Controls the visibility of lens flares from lights in the Scene.", null, null);
            public static readonly GUIContent FlareFadeSpeed = L10n.TextContent("Flare Fade Speed", "Controls the time over which lens flares fade from view after initially appearing.", null, null);
            public static readonly GUIContent SpotCookie = L10n.TextContent("Spot Cookie", "Specifies the Texture mask used to cast shadows, create silhouettes, or patterned illumination when using spot lights.", null, null);
        }
