...
namespace UnityEditor
{
    ...
    internal abstract class BaseInspectView : IBaseInspectView
    {
        ...
        {
            public static readonly GUIContent instructionsLabel = L10n.TextContent("Instructions", null, null, null);
            public static readonly GUIContent emptyViewLabel = L10n.TextContent("Select an Instruction on the left to see details", null, null, null);
