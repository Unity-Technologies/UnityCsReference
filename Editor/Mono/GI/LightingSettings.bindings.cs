...
namespace UnityEditor
{
    ...
    public sealed partial class LightingSettings : Object
    {
        ...
        internal extern Lightmapping.GIWorkflowMode giWorkflowMode { get; set; }

        public bool autoGenerate
        {
            get { return giWorkflowMode == Lightmapping.GIWorkflowMode.Iterative; }
            set { giWorkflowMode = (value ? Lightmapping.GIWorkflowMode.Iterative : Lightmapping.GIWorkflowMode.OnDemand); }
        }
