...
namespace UnityEditor.LightBaking
{
    ...
    internal struct LightmapRequest
    {
    ...
    internal enum MixedLightingMode
    {
        IndirectOnly = 0,
        Subtractive = 1,
        Shadowmask = 2,
    ...
    internal struct TextureTransform
    {
        public Vector2 scale;
        public Vector2 offset;
    };

    internal struct TextureProperties
    {
    ...
    internal struct Instance
    {
        ...
        public int lodGroup;
        public byte lodMask;
        public int contributingLodLevel; // LOD level in 'lodGroup' that contributes to GI, -1 if 'None' or if the instance is not in a LOD group
    ...
    internal struct LightingSettings
    {
    ...
    internal class ExternalProcessConnection : IDisposable
    {
        private IntPtr _ptr;
    ...
    [RequiredByNativeCode]
    [StructLayout(LayoutKind.Sequential)]
    internal class BakeInput : IDisposable
    {
        private IntPtr _ptr;
        private readonly bool _ownsPtr;
    ...
    [RequiredByNativeCode]
    [StructLayout(LayoutKind.Sequential)]
    internal class LightProbeRequests : IDisposable
    {
        private IntPtr _ptr;
        private readonly bool _ownsPtr;
        ...
        public extern void SetProbePositions(Vector3[] probePositions);
        public extern int[] GetOcclusionLightIndices();
        public extern void SetOcclusionLightIndices(int[] probePositions);
    ...
    [RequiredByNativeCode]
    [StructLayout(LayoutKind.Sequential)]
    internal class DeviceSettings : IDisposable
    {
        static extern IntPtr Internal_Create();
        [NativeMethod(IsThreadSafe = true)]
