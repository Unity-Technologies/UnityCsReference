...
namespace UnityEditor
{
    ...
    public enum BuildAssetBundleOptions
    {
        ...
        ///<remarks>This flag is useful for AssetBundles that are included in Player builds and are rebuilt for every new Player release.
        ...
        ///* Tools like <c>binary2text</c> and <see href="https://github.com/Unity-Technologies/UnityDataTools">UnityDataTools</see> cannot view the serialized data.</remarks>
