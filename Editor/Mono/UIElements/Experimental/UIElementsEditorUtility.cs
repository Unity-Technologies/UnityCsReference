...
namespace UnityEditor.Experimental.UIElements
{
    ...
    {
        internal static readonly string s_DefaultCommonStyleSheetPath = "StyleSheets/Experimental/DefaultCommon.uss";
        internal static readonly string s_DefaultCommonDarkStyleSheetPath = "StyleSheets/Experimental/DefaultCommonDark.uss";
        internal static readonly string s_DefaultCommonLightStyleSheetPath = "StyleSheets/Experimental/DefaultCommonLight.uss";
        ...
        internal static int GetCursorId(UnityEngine.UIElements.StyleSheet sheet, UnityEngine.UIElements.StyleValueHandle handle)
        {
