...
namespace UnityEditor.Experimental.UIElements
{
    static class Tooltip
    {
        internal static void SetTooltip(float mouseX, float mouseY)
        {
            ...
            if (view != null && view.uieMode == GUIView.UIElementsMode.Experimental && view.experimentalVisualTree != null && view.experimentalVisualTree.panel != null)
            {
                var panel = view.experimentalVisualTree.panel;
