...
namespace UnityEditorInternal
{
    ...
    {
        public static Texture2D GenerateGradientPreview(Gradient gradient, Texture2D existingTexture, ColorSpace gradientKeysColorSpace)
        {
            bool linearGradientKeys = gradientKeysColorSpace == ColorSpace.Linear;
            if(gradientKeysColorSpace == ColorSpace.Uninitialized)
            {
            ...
            return GenerateGradientPreview(gradient, existingTexture, linearGradientKeys);
        }
