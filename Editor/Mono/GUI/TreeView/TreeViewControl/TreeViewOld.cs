...
[Obsolete($"TreeView is now deprecated. You can likely now use TreeView<int> instead and not think more about it. But if you were using that identifier to store {nameof(EntityId)} data, you should instead opt to upgrade your TreeViews to use TreeView<{nameof(EntityId)}> to get the proper typing.", true)]
...
[Obsolete($"TreeViewItem is now deprecated. You can likely now use TreeViewItem<int> instead and not think more about it. But if you were using that identifier to store {nameof(EntityId)} data, you should instead opt to upgrade your TreeViews to use TreeViewItem<{nameof(EntityId)}> to get the proper typing.", true)]
...
[Obsolete($"TreeViewState is now deprecated. You can likely now use TreeViewState<int> instead and not think more about it. But if you were using that identifier to store {nameof(EntityId)} data, you should instead opt to upgrade your TreeViews to use TreeViewState<{nameof(EntityId)}> to get the proper typing.", true)]
