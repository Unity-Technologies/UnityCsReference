...
internal partial class DictionaryDrawer
{
    ...
    {
        internal static readonly string EmptyDictionaryLabel = L10n.Tr("Dictionary is empty", null);
        // Foldout title for a nested dictionary, replacing its entry "value" field's displayName ("Value").
        internal static readonly string NestedDictionaryLabel = L10n.Tr("Dictionary", null);
        ...
        internal static readonly string SingleItemCountLabel = L10n.Tr("1 item", null);
        internal static readonly string MultipleItemsCountFormat = L10n.Tr("{0} items", null);
        internal static readonly string IgnoredFormat = L10n.Tr("{0} ignored", null);
        internal static readonly string DuplicatesHelpBoxSingle = L10n.Tr("1 duplicate key ignored. Ensure all keys are unique.", null);
        internal static readonly string DuplicatesHelpBoxFormat = L10n.Tr("{0} duplicate keys ignored. Ensure all keys are unique.", null);
        ...
        internal static readonly string OneColumnWithValueFoldoutLayoutLabel = L10n.Tr("One Column With Value Foldout", null);
        internal static readonly string OneColumnWithValueVisibleLayoutLabel = L10n.Tr("One Column With Value Visible", null);
        internal static readonly string ShowSerializedOrderLabel = L10n.Tr("Show Serialized Order (Global)", null);
        internal static readonly string ShowingSerializedOrderInfoLabel = L10n.Tr("Showing serialized order", null);

        internal static readonly string DefaultKeyLabel = L10n.Tr("Key", null);
        internal static readonly string DefaultValueLabel = L10n.Tr("Value", null);
        // One-column mode stacks the key and value, so the single header column spans both.
        internal static readonly string OneColumnHeaderFormat = L10n.Tr("{0} & {1}", null);
