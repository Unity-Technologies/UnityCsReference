...
{
    [CustomPropertyDrawer(typeof(LoadableScene))]
    internal sealed class LoadableSceneDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            Debug.Assert(guidProperty != null, $"{nameof(LoadableSceneDrawer)} cannot find {kSceneGUIDPropName} property.");
        ...
        private static void OnValueChanged(Object value, SerializedProperty property, SerializedProperty guidProp)
        {
            ...
            {
                Debug.LogWarning("Unable to assign LoadableScene.", value);
            }
