...
namespace UnityEditor.Build.Profile
{
    ...
    internal sealed class BuildProfileContext : ScriptableObject
    {
        ...
        void OnEnable()
        {
            ...
            var buildProfile = GetForClassicPlatform(EditorUserBuildSettings.activeBuildTarget, EditorUserBuildSettings.standaloneBuildSubtarget);
        ...
        {
            var profile = activeProfile ?? instance.GetForClassicPlatform(EditorUserBuildSettings.activeBuildTarget, EditorUserBuildSettings.standaloneBuildSubtarget);
