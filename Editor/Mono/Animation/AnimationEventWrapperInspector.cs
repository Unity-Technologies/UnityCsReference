...
namespace UnityEditor
{
    ...
    internal class AnimationEventWrapperInspector : UnityEditor.Editor
    {
        ...
        {
            var awes = Array.ConvertAll(targets, o => o as AnimationEventWrapper);
        ...
        public static void OnEditAnimationEvent(AnimationEventWrapper awe, AnimationEventEditorState state)
        {
            OnEditAnimationEvents(new AnimationEventWrapper[] {awe}, state);
        }
        ...
        private static AnimationWindowEventData GetData(AnimationEventWrapper[] awEvents)
        {
            ...
            AnimationEventWrapper firstAwEvent = awEvents[0];
        ...
        private static void SetData(AnimationEventWrapper[] awEvents, AnimationWindowEventData data)
        {
            if (data.events == null)
                return;
        ...
        {
            AnimationEventWrapper awEvent = command.context as AnimationEventWrapper;
            AnimationEventWrapper[] awEvents = new AnimationEventWrapper[] { awEvent };
