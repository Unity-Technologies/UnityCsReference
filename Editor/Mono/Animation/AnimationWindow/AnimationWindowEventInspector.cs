...
namespace UnityEditor
{
    ...
    internal class AnimationWindowEventInspector : Editor
    {
        ...
        AnimationEventEditorState m_State = new AnimationEventEditorState();
        ...
        static Dictionary<Type, List<AnimationMethodMap>> s_TypeAnimationMethodMapCache = new Dictionary<Type, List<AnimationMethodMap>>();
        ...
        static void CollectSupportedMethods(GameObject gameObject, List<AnimationMethodMap> supportedMethods, List<AnimationMethodMap> overloadedMethods, List<AnimationMethodMap> duplicatedMethods)
        {
            ...
            foreach (MonoBehaviour behaviour in behaviours)
            {
                ...
                {
                    if (!s_TypeAnimationMethodMapCache.TryGetValue(type, out List<AnimationMethodMap> validMethods))
                    {
                        ...
                        validMethods = pendingValidMethods;
