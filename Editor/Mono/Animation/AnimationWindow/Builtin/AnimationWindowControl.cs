...
namespace UnityEditor.AnimationWindowBuiltin
{
    ...
    class AnimationWindowControl : IAnimationWindowController, IAnimationContextualResponder
    {
        class CandidateRecordingState : IAnimationRecordingState
        {
            ...
            public IAnimationWindowClip activeClip { get; private set; }
            ...
            public CandidateRecordingState(AnimationWindowState state, AnimationClip candidateClip)
            {
                ...
                activeClip = new AnimationWindowClip(candidateClip, activeRootGameObject);
            }
            ...
            {
                activeClip.SaveCurve(curve, "Edit Candidate Curve");
            }
        ...
        class RecordingState : IAnimationRecordingState
        {
            ...
            public GameObject activeGameObject => m_State.activeGameObject;
            public GameObject activeRootGameObject => m_State.activeRootGameObject;

            public AnimationClip activeAnimationClip
            {
                get
                {
                    var clip = m_State.selection.clip as AnimationWindowClip;
                    if (clip != null)
                    {
            ...
            public IAnimationWindowClip activeClip => m_State.selection.clip;
        ...
        public AnimationClip animationClip
        {
            get
            {
                var clip = state.selection.clip as AnimationWindowClip;
                if (clip != null)
                    return clip.animationClip;
        ...
        {
            EditorCurveBinding[] bindings = PropertyModificationsToEditorCurveBindings(modifications, state.activeRootGameObject, animationClip);
        ...
        public bool PlaybackUpdate()
        {
            ...
            var deltaTime = realtimeSinceStartup - m_PreviousUpdateTime;
            m_PreviousUpdateTime = realtimeSinceStartup;
        ...
        public bool canPreview
        {
            get
            {
                if (state.activeAnimationPlayer == null)
                    return false;
        ...
        private void RebuildGraph(Animator animator)
        {
            ...
            m_ClipPlayable = AnimationClipPlayable.Create(m_Graph, animationClip);
            ...
            if (requiresDefaultPose)
            {
                ...
                AnimationWindowUtility.CreateDefaultCurves(state, new AnimationWindowClip(m_DefaultPose, state.activeRootGameObject), streamBindings);
        ...
        private void ResampleAnimation(ResampleFlags flags)
        {
            ...
            if (animationClip != null)
            {
                ...
                if (usePlayableGraph)
                {
                    ...
                    m_ClipPlayable.SetSampleRate(playing ? -1 : animationClip.frameRate);
                    ...
                    AnimationUtility.SampleEulerHint(state.activeRootGameObject, animationClip, time, WrapMode.Clamp);
                    if (!m_CandidateClip.empty)
                        AnimationUtility.SampleEulerHint(state.activeRootGameObject, m_CandidateClip, time, WrapMode.Clamp);
                }
                else
                {
                    AnimationMode.SampleAnimationClip(state.activeRootGameObject, animationClip, time);
                    if (!m_CandidateClip.empty)
        ...
        {
            EditorCurveBinding[] bindings = PropertyModificationsToEditorCurveBindings(modifications, state.activeRootGameObject, m_CandidateClip);
            if (bindings.Length == 0)
                return;
        ...
        private void CreateCandidateClip()
        {
            ...
            m_CandidateClip.legacy = animationClip.legacy;
        ...
        public bool IsEditable(Object targetObject)
        {
            ...
            if (gameObject != null)
            {
                if (state.selection.IsCompatibleWith(gameObject))
                    return !state.selection.isReadOnly;
            }
        ...
        public bool CurveExists(PropertyModification[] modifications)
        {
            ...
            EditorCurveBinding[] clipBindings = AnimationUtility.GetCurveBindings(animationClip);
        ...
        public void RemoveCurve(PropertyModification[] modifications)
        {
            ...
            Undo.RegisterCompleteObjectUndo(animationClip, "Remove Curve");
        ...
        static EditorCurveBinding[] PropertyModificationsToEditorCurveBindings(PropertyModification[] modifications, GameObject rootGameObject, AnimationClip animationClip)
        {
            ...
            var array = new EditorCurveBinding[bindings.Count];
            bindings.CopyTo(array);

            return array;
        }

        static EditorCurveBinding[] SerializedPropertyToEditorCurveBindings(SerializedProperty property, GameObject rootGameObject, AnimationClip animationClip)
        {
