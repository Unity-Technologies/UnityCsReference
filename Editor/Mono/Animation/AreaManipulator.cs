...
{
    abstract class AreaManipulatorBase
    {
        public delegate bool OnStartDragDelegate(AreaManipulatorBase manipulator, Event evt);
        public delegate bool OnDragDelegate(AreaManipulatorBase manipulator, Event evt);
        public delegate bool OnEndDragDelegate(AreaManipulatorBase manipulator, Event evt);
        ...
        public AreaManipulatorBase()
        {
            // NoOps...
            onStartDrag += (AreaManipulatorBase manipulator, Event evt) => { return false; };
            onDrag += (AreaManipulatorBase manipulator, Event evt) => { return false; };
            onEndDrag += (AreaManipulatorBase manipulator, Event evt) => { return false; };
        }
    ...
    internal class AreaManipulator : AreaManipulatorBase
    {
