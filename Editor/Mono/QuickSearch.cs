        ...
        private static void OpenQuickSearch()
        {
            ...
            else
            {
                ...
                if (quickSearchPackage != null && EditorUtility.DisplayDialog(
                    ...
                    $"Do you want to install {quickSearchPackage.displayName} ({quickSearchPackage.version}) and be more productive?" +
                    $"\r\n\r\nPackage Description: {quickSearchPackage.description}", "Yes", "No"))
                {
                    ...
                    var packageIdToInstall = $"{quickSearchPackage.name}@{quickSearchPackage.version}";
