...
namespace UnityEditor.SearchService
{
    ...
    public static partial class ProjectSearch
    {
        ...
        // The engineImp property calls StaticInit() whenever this is null, and StaticInit also runs from the
        // first tick after every code load, so the engine wrapper is recreated before it is used.
        [IgnoreForUAL0015("Engine wrapper recreated by StaticInit() on the next access after cleanup nulls it")]
