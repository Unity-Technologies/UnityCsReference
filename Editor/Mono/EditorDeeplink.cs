...
namespace UnityEditor
{
    ...
    internal static class EditorDeeplink
    {
        ...
        public static void Internal_OpenDeeplinkInEditor(string openInEditorUrl)
        {
            ...
            // If the assembly of the handler is in a package from the Unity Package Manager registry or in a fully trusted package.
            if (methodPackageInfo != null && (methodPackageInfo.registry.isDefault || methodPackageInfo.trustLevel == UnityEditor.PackageManager.TrustLevel.FullTrust))
            {
