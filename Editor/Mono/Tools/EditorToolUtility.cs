...
namespace UnityEditor.EditorTools
{
    ...
    static class EditorToolUtility
    {
        ...
        {
            return GetContextCache(toolOwner).GetEditorsForTargetType(null);
        }
        ...
        {
            return GetContextCache(toolOwner).availableEditorTypeAssociations;
        }
        ...
        {
            return GetToolCache(toolOwner).availableEditorTypeAssociations;
        }
        
        internal static int GetToolContextsInProject(Type toolOwnerType)
        {
            return GetContextCache(toolOwnerType).Count;
        }
...
#pragma warning restore UA2001
        ...
        {
#pragma warning disable UA2001 // The Banned API Analyzer produces compile errors for any new Linq code. This pre-existing usage has been suppressed, but should be rewritten if possible.
            var globalEditorTools = GetCustomEditorToolsForType(null, toolOwner).Where(t => EditorToolManager.additionalContextToolTypesCache.All(tc => tc != t.editor));
#pragma warning restore UA2001
