...
namespace UnityEditor.VersionControl
{
    ...
    internal class WindowChange : EditorWindow
    {
        ...
        internal WindowChange() {} // this side effect does not outlive the current call (global trigger / lazily-loaded asset re-fetched on next access); a stale reference is harmlessly replaced

        ListControl submitList = new ListControl(); // rebuilt/resubscribed wholesale on the next reload via this object's own lifecycle; a stale value in the interim is never observed
