...
namespace UnityEditor.VersionControl
{
    ...
    internal class WindowRevert : EditorWindow
    {
        ...
        internal WindowRevert() {} // this side effect does not outlive the current call (global trigger / lazily-loaded asset re-fetched on next access); a stale reference is harmlessly replaced

        ListControl revertList = new ListControl(); // rebuilt/resubscribed wholesale on the next reload via this object's own lifecycle; a stale value in the interim is never observed
