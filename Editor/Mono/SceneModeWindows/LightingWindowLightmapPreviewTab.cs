...
namespace UnityEditor
{
    internal class LightingWindowLightmapPreviewTab : LightingWindow.WindowTab
    {
        ...
        static class Styles
        {
            ...
            public static readonly GUIContent LightingDataAsset = L10n.TextContent("Lighting Data Asset", "A different LightingData.asset can be assigned here. These assets are generated by baking a scene in the OnDemand mode.", null, null);
            ...
            public static readonly GUIContent BakedLightmapsFoldoutTitle = L10n.TextContent("Baked Lightmaps", null, null, null);
            public static readonly GUIContent PreviewLightmapsFoldoutTitle = L10n.TextContent("Preview Lightmaps", null, null, null);
        }
