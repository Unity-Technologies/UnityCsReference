...
#pragma warning restore UA5000
        ...
        internal string localizedDisplayName
        {
            ...
            get
            {
                if (!this.isValidDisplayNameCache)
                {
                    ...
                    m_CachedLocalizedDisplayName = L10n.TrForContext(displayName, m_SerializedObject.targetObject);
                }
        ...
        internal string[] enumLocalizedDisplayNames
        {
            get
            {
                ...
                {
                    res[i] = L10n.TrForContext(names[i], m_SerializedObject.targetObject);
                }
                return res;
            }
        }
        ...
        // The maximum number of elements this array can be resized to: the lesser of the maximum
        // serialized object size and a practical memory budget for this machine (int.MaxValue when
        // not an array).
        internal int maxArraySize
        {
            get
            {
                Verify(VerifyFlags.IteratorNotAtEnd);
        ...
        extern private int GetMaxArraySize();
