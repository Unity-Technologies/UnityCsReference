...
namespace UnityEditor
{
    ...
    internal class CanvasEditor : Editor
    {
        ...
        {
            public static readonly GUIContent eventCamera = L10n.TextContent("Event Camera", "The Camera which the events are triggered through. This is used to determine clicking and hover positions if the Canvas is in World Space render mode.", null, null);
            public static readonly GUIContent renderCamera = L10n.TextContent("Render Camera", "The Camera which will render the canvas. This is also the camera used to send events.", null, null);
            public static readonly GUIContent sortingOrder = L10n.TextContent("Sort Order", "The order in which Screen Space - Overlay canvas will render", null, null);
            ...
            public static readonly GUIContent targetDisplay = L10n.TextContent("Target Display", "Display on which to render the canvas when in overlay mode", null, null);
            ...
            public static readonly GUIContent m_ShaderChannel = L10n.TextContent("Additional Shader Channels", null, null, null);
            public static readonly GUIContent pixelPerfectContent = L10n.TextContent("Pixel Perfect", null, null, null);
            public static readonly GUIContent standaloneRenderResize = L10n.TextContent("Resize Canvas", "For manual Camera.Render calls should the canvas resize to match the destination target.", null, null);
            public static readonly GUIContent vertexColorAlwaysGammaSpace = L10n.TextContent("Vertex Color Always In Gamma Color Space", "UI vertex colors are always in gamma color space disregard of the player settings", null, null);
            public static readonly GUIContent useReflectionProbes = L10n.TextContent("Reflection Probes", "Allows shaders in the canvas to access data from Reflection Probes", null, null);
        }
