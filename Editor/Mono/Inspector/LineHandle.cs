            ...
            switch (evtType)
            {
                ...
                case EventType.MouseMove:
                {
                    ...
                    if (line != null && line.Length > 1)
                        HandleUtility.AddControl(id, HandleUtility.DistanceToPolyLine(line, loop, out discard));
                    break;
                }
                ...
                case EventType.Repaint:
                {
                    ...
                    HandleUtility.DistanceToPolyLine(line, loop, out hoveredEdgeIndex);
                ...
                case EventType.MouseDown:
                {
                    if (HandleUtility.nearestControl == id && evt.button == 0 && GUIUtility.hotControl == 0 && !evt.alt)
                    {
                        ...
                        HandleUtility.DistanceToPolyLine(line, loop, out nearestEdgeIndex);
