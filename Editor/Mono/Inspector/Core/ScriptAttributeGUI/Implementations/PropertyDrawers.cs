...
namespace UnityEditor
{
    ...
    {
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use Range with float or int.", null);
    ...
    {
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use Min with float, int or Vector.", null);
    ...
    {
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use Multiline with string.", null);
    ...
    internal sealed class TextAreaDrawer : PropertyDrawer
    {
        ...
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use TextAreaDrawer with string.", null);
    ...
    {
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use ColorUsageDrawer with color.", null);
    ...
    {
        private static readonly string s_InvalidTypeMessage = L10n.Tr("Use GradientUsageDrawer with gradient.", null);
    ...
    {
        static readonly string s_InvalidTypeMessageIMGUI = L10n.Tr("Use Delayed with float, int or string when using IMGUI.", null);
        static readonly string s_InvalidTypeMessageUITK = L10n.Tr("Use Delayed with float, int, string, Vector or Rect when using UI Toolkit.", null);
