...
namespace UnityEditor
{
    ...
    internal class AnimationEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EntityId newAnimID = clipProperty.objectReferenceEntityIdValue;
            ...
            if (m_PrePreviewAnimationArraySize != -1)
            {
                ...
                EntityId lastAnimID = arrSize > 0 ? arrProperty.GetArrayElementAtIndex(arrSize - 1).objectReferenceEntityIdValue : EntityId.None;
