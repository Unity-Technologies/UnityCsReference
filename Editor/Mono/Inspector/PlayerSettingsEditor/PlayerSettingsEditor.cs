...
namespace UnityEditor
{
    ...
    internal partial class PlayerSettingsEditor : Editor
    {
        static class Styles
        {
            ...
            public static readonly GUIContent vrOrientationInfo = EditorGUIUtility.TextContent("Virtual Reality Support is enabled. Upon entering VR mode, landscape left orientation will be the default orientation unless only landscape right is available.");
