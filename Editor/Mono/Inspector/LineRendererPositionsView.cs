...
#pragma warning restore UAC2001
        ...
        protected override DragAndDropVisualMode HandleDragAndDrop(DragAndDropArgs args)
        {
            ...
            if (args.performDrop)
            {
                ...
                {
                    if (!EditorUtility.DisplayDialog(L10n.Tr("Moving an array element will copy the complete array to all other selected objects.", null),
                        L10n.Tr("Unique values in the different selected objects will be lost", null),
                        L10n.Tr("OK", null),
                        L10n.Tr("Cancel", null)))
                    {
