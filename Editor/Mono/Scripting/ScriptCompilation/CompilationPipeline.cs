...
namespace UnityEditor.Compilation
{
    ...
    public static partial class CompilationPipeline
    {
        ...
        internal static Assembly[] GetPlayerAssemblies(EditorCompilation editorCompilation, EditorScriptCompilationOptions options, string[] extraScriptingDefines = null)
        {
            ...
            var precompiledAssemblies = EditorCompilationInterface.Instance.PrecompiledAssemblyProvider.GetPrecompiledAssembliesDictionary(options, group, target, extraScriptingDefines);
