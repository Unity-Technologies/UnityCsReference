...
#pragma warning restore CS0612 // Type or member is obsolete
            ...
            if (scriptCompilationState.Settings.BuildingForEditor)
            {
            ...
            if (_logCompilationMessages)
            {
                ...
                foreach (var message in compilerMessages)
                {
                    ...
                    if (message.type != CompilerMessageType.Information)
                        Debug.LogCompilerMessage(message.message, message.file, message.line, message.column, scriptCompilationState.Settings.BuildingForEditor, message.type == CompilerMessageType.Error, logIdentifier);
                }
            }
