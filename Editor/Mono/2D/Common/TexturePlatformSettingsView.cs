...
namespace UnityEditor.U2D.Common
{
    internal class TexturePlatformSettingsView : ITexturePlatformSettingsView
    {
        class Styles
        {
            ...
            public readonly GUIContent useAlphaSplitLabel = EditorGUIUtility.TextContent("Split Alpha Channel|Alpha for this texture will be preserved by splitting the alpha channel to another texture, and both resulting textures will be compressed using ETC1.");
