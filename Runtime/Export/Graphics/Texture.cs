    ...
    public partial class Texture2D : Texture
    {
        ...
        public Texture2D(int width, int height)
        {
            ...
            if (width == 0 && height == 0)
                ...
                Internal_Create(this, width, height, Texture.GenerateAllMips, GraphicsFormatUtility.GetGraphicsFormat(format, !linear), GetTextureColorSpace(linear), TextureCreationFlags.MipChain, IntPtr.Zero, null);
        }
