...
namespace Unity.DataModel
{
    ...
    internal sealed partial class UDM
    {
        ...
        //                                                                 const udm_type_id_t*         underlying_type_id,
        //                                                                 uint64_t                     alignment,
        //                                                                 uint64_t                     size,
        //                                                                 int                          is_fundamental,
        //                                                                 int                          is_trivially_copyable,
        //                                                                 int                          has_dynamic_data,
        ...
        // UDM_API uint32_t udm_xxhash32(const void* p, uint64_t len);
        [FreeFunction("udm_xxhash32", IsThreadSafe = true)]
        unsafe internal static extern uint udm_xxhash32(byte* data, ulong size);
        // UDM_API udm_hash_t udm_xxh3_128(const uint8_t* data, uint64_t size);
        [FreeFunction("udm_xxh3_128", IsThreadSafe = true)]
        internal static extern unsafe udm_hash udm_xxh3_128(byte* data, ulong size);
        ...
        // UDM_API void                udm_schema_builder_set_as_fixed_buffer(udm_schema_builder_t* schema_builder, int is_fixed_buffer);
        [FreeFunction("udm_schema_builder_set_as_fixed_buffer", IsThreadSafe = true)]
        unsafe internal static extern void udm_schema_builder_set_as_fixed_buffer(udm_schema_builder_ptr schema_builder, int is_fixed_buffer);
        // UDM_API void                udm_schema_builder_set_as_managed(udm_schema_builder_t* schema_builder, int is_managed);
        [FreeFunction("udm_schema_builder_set_as_managed", IsThreadSafe = true)]
        unsafe internal static extern void udm_schema_builder_set_as_managed(udm_schema_builder_ptr schema_builder, int is_managed);
        // UDM_API void                udm_schema_builder_set_underlying_type_id(udm_schema_builder_t* schema_builder, const udm_type_id_t* underlying_type_id);
        [FreeFunction("udm_schema_builder_set_underlying_type_id", IsThreadSafe = true)]
        unsafe internal static extern void udm_schema_builder_set_underlying_type_id(udm_schema_builder_ptr schema_builder, udm_const_type_id* underlying_type_id);
        ...
        unsafe internal static extern udm_const_schema* udm_schema_builder_build_basic_schema_with_underlying_type(IntPtr schema_manager_ptr, udm_const_type_id* underlying_type_id, string type_name, udm_const_type_id* type_id, ulong type_version, int is_managed);
        ...
        //
        // UDM_API const udm_reference_t*                    udm_binary_header_get_references(const udm_binary_header_t* header);
        //
        ...
        unsafe internal static extern void udm_document_model_extract_external_document_ids(udm_document_model_ptr document_model);
        ...
        unsafe internal static extern udm_const_reference* udm_document_model_get_references(udm_const_document_model_ptr document_model);
        // UDM_API const uint64_t          udm_document_model_get_references_size(const udm_document_model_t* document_model);
        [FreeFunction("udm_document_model_get_references_size", IsThreadSafe = true)]
        unsafe internal static extern ulong udm_document_model_get_references_size(udm_const_document_model_ptr document_model);
        // UDM_API void                     udm_document_model_set_reference(udm_document_model_t* document_model, udm_reference_field_t* field, udm_reference_t reference);
        [FreeFunction("udm_document_model_set_reference", IsThreadSafe = true)]
        unsafe internal static extern void udm_document_model_set_reference(udm_document_model_ptr document_model, udm_reference_field* field, udm_reference reference);
