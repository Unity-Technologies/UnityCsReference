...
namespace UnityEngine
{
    ...
    public partial struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        // Multiplies every component of this vector by the same component of /scale/.
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        public void Scale(in Vector3 scale) { x *= scale.x; y *= scale.y; z *= scale.z; }
        ...
        // Dot Product of two vectors.
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        public static float Dot(in Vector3 lhs, in Vector3 rhs) => lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z;
        ...
        // *undoc* --- there's a property now
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        public static float Magnitude(in Vector3 vector) => vector.magnitude;
        ...
        // *undoc* --- there's a property now
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        public static float SqrMagnitude(in Vector3 vector) => vector.sqrMagnitude;
