...
namespace UnityEngine.SocialPlatforms.Impl
{
    ...
    public class UserProfile : IUserProfile
    {
        ...
        [ObsoleteAttribute(@"legacyId returns playerID from GKPlayer, which became obsolete in iOS 12.4 . id returns playerID for devices running versions before iOS 12.4, and the newer teamPlayerID for later versions. Please use IUserProfile.id or UserProfile.id instead (UnityUpgradable) -> id")]
        public string legacyId { get { return m_legacyID; } }
