...
namespace UnityEngine.TextCore.LowLevel
{
    ...
    public sealed class FontEngine
    {
        ...
        internal static GlyphPairAdjustmentRecord[] GetGlyphPairAdjustmentTable(uint[] glyphIndexes)
        {
            ...
            s_GlyphPairAdjustmentRecords_MarshallingArray[recordCount] = new GlyphPairAdjustmentRecord();
        ...
        /// <summary>
        /// Internal function used to retrieve the potential GlyphPairAdjustmentRecord for the given pair of glyph indexes.
        /// </summary>
