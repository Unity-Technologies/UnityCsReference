...
internal sealed class RemoveVariableCommand : Command<RemoveVariableCommand>
{
    const string CommandUndoName = "Remove variable";

    public static RemoveVariableCommand GetPooled(
        object source,
    ...
    public override bool Validate() => Rule != null;
