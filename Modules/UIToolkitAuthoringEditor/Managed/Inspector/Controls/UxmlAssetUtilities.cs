...
internal static class UxmlAssetUtilities
{
    ...
    public static SynchronizePathResult SyncUxmlObjectChanges(VisualTreeAsset visualTreeAsset
        , UxmlSerializedData uxmlSerializedData
        , UxmlAsset parentAsset
        , string serializedBasePath
        , string propertyPath
        ...
        , Action<VisualTreeAsset, VisualElement> onDeserializeElement = null)
    {
        ...
        var ret = SynchronizePath(visualTreeAsset,
            uxmlSerializedData,
            parentAsset,
            serializedBasePath,
            propertyPath, true);
        onDeserializeElement?.Invoke(visualTreeAsset, element);
    ...
    public static string GetUndoMessage(SerializedProperty prop)
    {
        ...
        if (prop.serializedObject.targetObject.name != string.Empty)
            undoMessage += $" in {prop.serializedObject.targetObject.name}";

        return undoMessage;
    }

    public static SynchronizePathResult AddUxmlObjectToSerializedData(UxmlAttributesEditingContext context,
        SerializedProperty property,
        UxmlSerializedData serializedData)
    {
        return AddUxmlObjectToSerializedData(context, property, null, serializedData);
    }
    ...
    public static SynchronizePathResult AddUxmlObjectToSerializedData(UxmlAttributesEditingContext context,
        ...
        Type type)
    {
        return AddUxmlObjectToSerializedData(context, property, type, null);
    }

    public static SynchronizePathResult AddUxmlObjectToSerializedData(UxmlAttributesEditingContext context,
        SerializedProperty property,
        Type type,
        UxmlSerializedData serializedData = null)
    {
    ...
    static void RecordDocumentUndoOnce(UxmlAttributesEditingContext context)
    {
        if (!s_DocumentUndoRecorded)
        {
            UndoRecordDocument(context, "Modify UXML Object");
            s_DocumentUndoRecorded = true;
        }
    }

    public static void UndoRecordDocument(UxmlAttributesEditingContext context, string reason)
    {
