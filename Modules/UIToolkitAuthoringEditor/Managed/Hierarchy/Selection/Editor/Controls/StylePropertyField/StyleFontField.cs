...
namespace Unity.UIToolkit.Editor
{
    ...
    internal class StyleFontField : StylePropertyField<StyleFont, FontField, Font>
    {
        ...
        protected override FontField CreateValueField()
        {
            return new FontField();
        }

        protected override StyleFont CreateStyleValue(Font v)
        {
            return v;
        }

        internal override bool EqualsCurrentValue(StyleFont v)
        {
            return value == v;
        }
    }
