...
[UsedImplicitly]
internal sealed class HierarchyVisualElementNodeTypeHandler : VisualElementNodeTypeHandler
{
    ...
    private static void RegisterHierarchyHandlers()
    {
        ...
        {
            HierarchyWindow.RegisterNodeTypeHandler<HierarchyVisualElementNodeTypeHandler>();
        };
    }
    ...
    {
        HierarchyWindow.UnregisterNodeTypeHandler<HierarchyVisualElementNodeTypeHandler>();
    }
    ...
    public HierarchyVisualElementNodeTypeHandler()
