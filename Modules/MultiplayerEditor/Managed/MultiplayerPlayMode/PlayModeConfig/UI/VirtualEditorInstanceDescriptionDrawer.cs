...
{
    [CustomPropertyDrawer(typeof(VirtualEditorInstanceDescription), true)]
    class VirtualEditorInstanceDescriptionDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            if (hasScenarioAndInstance && scenario.Scenario != null && !scenario.Scenario.HasActiveFreeRunInstanceOfType<CloneEditorController>())
            {
        ...
        private void DisableInstanceContainerIfFreeRunningActive(VisualElement container, SerializedProperty property)
        {
            ...
            if (!scenarioConfig.Scenario.HasActiveFreeRunInstance<CloneEditorController>(name: instanceConfig.Name))
                return;
            ...
            var disableEditingHelpbox = new HelpBox(ScenarioConfigEditor.k_DisabledInstanceHelpBoxText, HelpBoxMessageType.Info) { name = ScenarioConfigEditor.k_DisabledInstanceHelpBoxName };
