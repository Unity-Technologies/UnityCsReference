...
namespace UnityEngine.Bindings
{
    ...
    internal ref struct OutArray<T> where T : unmanaged
    {
        ...
        public unsafe static class BindingsMarshaller
        {
            ...
            {
                return new OutArray<T> { array = UnsafeUtilityInternal.ClassAsRef<T[]>((void*)unmanaged.arrayRef) };
            }
        }
    ...
    internal ref struct OutArray2D<T> where T : unmanaged
    {
        ...
        public unsafe static class BindingsMarshaller
        {
            ...
            {
                return new OutArray2D<T>  { array = UnsafeUtilityInternal.ClassAsRef<T[,]>((void*)unmanaged.arrayRef) };
            }
        }
    ...
    internal ref struct OutArray3D<T> where T : unmanaged
    {
        ...
        public unsafe static class BindingsMarshaller
        {
            ...
            {
                return new OutArray3D<T> { array = UnsafeUtilityInternal.ClassAsRef<T[,,]>((void*)unmanaged.arrayRef) };
            }
        }
    ...
    static class CreateAndFillCalbacks
    {
        ...
        {
            ref Array arrayRef = ref UnsafeUtilityInternal.ClassAsRef<Array>((void*)arrayPointer);
            arrayRef = ((delegate*<int, Array>)createArrayCb)(size);

            fixed (byte* arrayData = Unsafe.As<byte[]>(arrayRef))
            {
