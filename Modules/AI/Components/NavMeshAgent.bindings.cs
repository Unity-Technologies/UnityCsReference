...
namespace UnityEngine.AI
{
    ...
    public sealed class NavMeshAgent : Behaviour
    {
        ...
        ///<remarks>If the path is succesfully assigned the agent will resume movement toward the new target.
        ///If the path cannot be assigned the path will be cleared (see <see cref="ResetPath" />).</remarks>
