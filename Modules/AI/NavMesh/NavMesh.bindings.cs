...
namespace UnityEngine.AI
{
    ...
    ///See also:
    ///
    ///• <see href="https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0/manual/CreateNavMesh.html">Create a NavMesh</see> – for more information on how to setup and bake NavMesh.
    ///• <see href="https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0/manual/AreasAndCosts.html">Areas and Costs</see> – to learn how to use different Area types.
    ...
    ///• <see href="https://docs.unity3d.com/Packages/com.unity.ai.navigation@2.0/api/Unity.AI.Navigation.NavMeshLink.html">NavMesh Link</see> – to learn how to control off-mesh links using scripting.
    ///• <see cref="Unity.AI.Navigation.LowLevel.NavWorld" /> – to learn how to run NavMesh queries in parallel <see href="https://docs.unity3d.com/Manual/job-system.html">jobs</see>.
    ///</remarks>
