...
namespace Unity.GraphToolsFoundation.Editor
{
    ...
    class ContextNode : CollapsibleInOutNode, IShowItemLibraryUI_Internal
    {
        ...
        /// <summary>
        /// The <see cref="ContextBlocksPart"/> contained in this <see cref="ContextNode"/>
        /// </summary>
        ...
        protected override void BuildPartList()
        {
            ...
            ContextBlocksPart = ContextBlocksPart.Create(blocksPartName, NodeModel, this, ussClassName);
        ...
        public virtual bool ShowItemLibrary(Vector2 mousePosition)
        {
            ...
            return ShowItemLibrary_Internal(mousePosition, index);
        }
        ...
        protected override void OnCustomStyleResolved(CustomStyleResolvedEvent e)
        {
            ...
            var changed = false;
            if (e.customStyle.TryGetValue(BlockNode.BlocksBackgroundColorStyle, out Color bkgndColor))
            {
        ...
        void GenerateBlocksVisualContent(MeshGenerationContext mgc)
        {
            ...
            BlockNode.DrawBlock_Internal(ref bounds, p2d, true, true, true, ref drawParams);
