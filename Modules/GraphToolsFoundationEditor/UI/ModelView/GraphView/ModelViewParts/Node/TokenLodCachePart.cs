    ...
    class TokenLodCachePart: GraphElementPart
    {
        ...
        protected override void UpdatePartFromModel()
        {
            if (m_Model is InputOutputPortsNodeModel node)
            {
                ...
                {
                    m_OwnerElement.RootView.TypeHandleInfos.RemoveUssClasses(Port.dataTypeClassPrefix, m_Icon, output.DataTypeHandle);
                    m_CurrentTypeHandle = output.DataTypeHandle;
                    m_OwnerElement.RootView.TypeHandleInfos.AddUssClasses(Port.dataTypeClassPrefix, m_Icon, output.DataTypeHandle);
                }
