...
{
    /// <summary>
    /// A part to build the UI for the <see cref="IconTitleProgressPart"/> of a <see cref="SubgraphNodeModel"/>.
    /// </summary>
    class SubgraphIconTitleProgressPart : IconTitleProgressPart
    {
        /// <summary>
        ...
        public static SubgraphIconTitleProgressPart Create(string name, Model model, ModelView ownerElement, string parentClassName)
        {
            return model is SubgraphNodeModel subgraphNode ? new SubgraphIconTitleProgressPart(name, subgraphNode, ownerElement, parentClassName) : null;
        }
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        SubgraphIconTitleProgressPart(string name, GraphElementModel model, ModelView ownerElement, string parentClassName)
