...
{
    [Overlay(typeof(SceneView), k_OverlayID, "Lighting Visualization", defaultDisplay = false, priority = (int)OverlayPriority.LightingVisualization, defaultDockZone = DockZone.RightColumn, defaultDockIndex = 0, group = OverlayAttribute.unityGroup)]
    ...
    [Overlay(typeof(SceneView), k_OverlayID, "PBR Validation Settings", priority = (int)OverlayPriority.PBRValidation, defaultDockZone = DockZone.RightColumn, defaultDockIndex = 0, group = OverlayAttribute.unityGroup)]
    ...
    [Overlay(typeof(SceneView), k_OverlayID, "Lighting Visualization Colors", priority = (int)OverlayPriority.LightingVisualizationColor, defaultDockZone = DockZone.LeftColumn, defaultDockIndex = 0, group = OverlayAttribute.unityGroup)]
