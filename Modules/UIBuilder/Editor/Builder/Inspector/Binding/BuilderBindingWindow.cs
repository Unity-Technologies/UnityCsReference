...
namespace Unity.UI.Builder
{
    ...
    partial class BuilderBindingWindow : EditorWindow
    {
        ...
        // The window closes itself on beforeAssemblyReload, so no window is open next to a cleared slot;
        // the next Open call assigns it again.
        [IgnoreForUAL0015("Transient window handle; the window closes on reload and Open reassigns it")]
