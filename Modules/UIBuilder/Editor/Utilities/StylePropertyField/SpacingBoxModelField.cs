...
namespace Unity.UI.Builder
{
    class SpacingBoxModel : VisualElement
    {
        ...
        static readonly string k_MouseOverClassName = "mouse-over";
        ...
        public SpacingBoxModel()
        {
            ...
            m_MarginBox.AddToClassList(k_CheckerboardClassName);
    ...
    internal class SpacingBoxModelField : StyleRow
    {
        ...
        const string k_PaddingTopFieldName = "paddingTop";
        const string k_PaddingRightFieldName = "paddingRight";
        const string k_PaddingBottomFieldName = "paddingBottom";
        const string k_PaddingLeftFieldName = "paddingLeft";

        const string k_MarginTopFieldName = "marginTop";
        const string k_MarginRightFieldName = "marginRight";
        const string k_MarginBottomFieldName = "marginBottom";
        const string k_MarginLeftFieldName = "marginLeft";
        ...
        public SpacingBoxModelField()
        {
            ...
            Track(k_MarginTopFieldName);
            Track(k_MarginRightFieldName);
            Track(k_MarginBottomFieldName);
            Track(k_MarginLeftFieldName);

            Track(k_PaddingTopFieldName);
            Track(k_PaddingRightFieldName);
            Track(k_PaddingBottomFieldName);
            Track(k_PaddingLeftFieldName);
