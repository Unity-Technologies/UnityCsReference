...
{
    [UsedImplicitly]
    internal class RatioStyleField : TextValueField<Ratio>
    {
        public class RatioStyleFieldConverter : UxmlAttributeConverter<Ratio>
        {
            public override Ratio FromString(string value) => throw new NotImplementedException();
            public override string ToString(Ratio value) => throw new NotImplementedException();
        }
        ...
        public new class UxmlSerializedData : BaseField<Ratio>.UxmlSerializedData
        {
            ...
            public override object CreateInstance() => new RatioStyleField();
        }
        ...
        public RatioStyleField() : this((string)null) { }

        public RatioStyleField(int maxLength)
            : this(null, maxLength) { }

        public RatioStyleField(string label, int maxLength = kMaxValueFieldLength)
        ...
        {
            RatioStyleField parentLengthField => (RatioStyleField)parent;
