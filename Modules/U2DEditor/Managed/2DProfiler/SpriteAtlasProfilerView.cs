...
namespace UnityEditor.U2D.Profiling
{
    internal class SpriteNode
    {
        ...
        public EntityId spriteAtlasEntityId;
        public EntityId textureEntityId;

        public SpriteNode(int id, string assetName, string assetGuid,
            string spriteAssetName, string textureAssetName, float ratioSpriteInTexture,
            EntityId entityId, EntityId spriteAtlasEntityId, EntityId textureEntityId)
        {
            this.id = id;
            ...
            this.spriteAtlasEntityId = spriteAtlasEntityId;
            this.textureEntityId = textureEntityId;
        }
    }
    ...
    internal class TextureNode
    {
        ...
        public TextureNode(string textureName, int textureId, EntityId entityId)
        {
    ...
    internal class SpriteAtlasNode
    {
        ...
        public SpriteAtlasNode(string atlasGuid, string atlasName, int atlasId, EntityId entityId)
        {
        ...
        private void GroupByAtlas()
        {
            ...
            foreach (var kvp in m_AtlasGroupsBuffer)
            {
                ...
                var atlasNode = new SpriteAtlasNode(
                    ...
                    m_NextId++,
                    firstSprite.spriteAtlasEntityId
                );
                ...
                foreach (var textureKvp in m_TextureGroupsBuffer)
                {
                    ...
                    if(spriteList.Count == 0)
                        continue;
                    var textureNode = new TextureNode(textureKvp.Key, m_NextId++, spriteList[0].textureEntityId);
    ...
    internal partial class SpriteAtlasProfilerInfoView
    {
        ...
        public VisualElement CreateGUI()
        {
            ...
            m_Table.selectedIndicesChanged += SelectionChanged;
        ...
        void SelectionChanged(IEnumerable<int> obj)
        {
            var cellData = m_Table.GetItemDataForIndex<SpriteAtlasProfilerCellData>(m_Table.selectedIndex);
            if (cellData != null)
            {
