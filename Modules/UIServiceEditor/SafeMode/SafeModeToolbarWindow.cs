...
namespace UnityEditor
{
    class SafeModeToolbarWindow : EditorWindow
    {
        ...
        static bool s_IsPreviewPackagesInUse;
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent previewPackageContent = EditorGUIUtility.TrTextContent("Preview Packages in Use");
            public static readonly GUIContent previewPackageIcon = EditorGUIUtility.TrIconContent("PreviewPackageInUse", "Preview Packages in Use");
        ...
        internal void OnGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                const float k_PreviewPackagesinUseCompleteWidth = 173;
                const float k_PreviewPackagesinUseIconWidth = 45;
                var previewPackagesinUseWidth = k_PreviewPackagesinUseCompleteWidth;
                var useIcon = false;

                var showPreviewPackagesInUseDropDown = s_IsPreviewPackagesInUse && !m_PackageManagerPrefs.dismissPreviewPackagesInUse;
