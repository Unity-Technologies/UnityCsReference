...
namespace Unity.LowLevel
{
    ...
    {
        [VisibleToOtherModules]
        internal static void AppendHash(
            ref Hash128 inHash,
            ref Hash128 outHash
        )
        {
        ...
        [VisibleToOtherModules]
        internal static unsafe void ComputeHash128<T>(ref T value, ref Hash128 hash)
            where T : struct
        {
        ...
        [VisibleToOtherModules]
        internal static unsafe void ComputeHash128(byte[] value, ref Hash128 hash)
        {
