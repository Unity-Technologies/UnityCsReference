...
#pragma warning disable CS0618 // TextCoreShaderGUI, TextCoreShaderGUISDF, TextCoreShaderGUIBitmap, TextShaderUtilities are obsolete; handled natively by Advanced Text Generator (ATG)
...
namespace UnityEditor.TextCore.Text
{
    ...
    public abstract class TextCoreShaderGUI : ShaderGUI
    {
        ...
        void DoTexture(string name, string label, System.Type type, bool withTilingOffset = false, string[] speedNames = null)
        {
            ...
            EditorGUI.BeginChangeCheck();
            UnityEngine.Object tex = EditorGUI.ObjectField(rect, s_TempLabel, property.textureValue, type, false);
            if (EditorGUI.EndChangeCheck())
            {
