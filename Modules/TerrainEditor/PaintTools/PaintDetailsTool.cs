    ...
    internal class PaintDetailsTool : TerrainPaintTool<PaintDetailsTool>
    {
        ...
        private void ShowTextureFallbackWarning(ref Terrain terrain)
        {
            ...
            foreach (var prototype in terrain.terrainData.detailPrototypes)
            {
                ...
                hasCompressedPrototypeTexture = sourceTexture != null && GraphicsFormatUtility.IsCompressedFormat(sourceTexture.graphicsFormat);
            }
            if (hasCompressedPrototypeTexture && !GraphicsFormatUtility.IsCompressedFormat((GraphicsFormat)terrain.terrainData.atlasFormat))
            {
