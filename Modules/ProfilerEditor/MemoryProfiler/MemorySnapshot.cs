...
namespace UnityEditor.Profiling.Memory.Experimental
{
    ...
    {
        static readonly uint kMinSupportedVersion = 8;
        static readonly uint kConnectionsRemapVersion = 10;
        static readonly uint kCurrentVersion = 11;
        ...
        internal void BuildEntries()
        {
            ...
            nativeObjects = new NativeObjectEntries(m_Reader, version >= kConnectionsRemapVersion);
