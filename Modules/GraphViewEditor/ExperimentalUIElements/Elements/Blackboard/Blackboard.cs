...
namespace UnityEditor.Experimental.UIElements.GraphView
{
    public class Blackboard : GraphElement
    {
        ...
        internal static readonly string StyleSheetPath = "StyleSheets/GraphViewExperimental/Blackboard.uss";
        ...
        public Blackboard()
        {
            var tpl = EditorGUIUtility.Load("UXML/GraphViewExperimental/Blackboard.uxml") as VisualTreeAsset;
