...
namespace UnityEditor.Experimental.UIElements.GraphView
{
    public class TokenNode : Node
    {
        ...
        public TokenNode(Port input, Port output) : base("UXML/GraphViewExperimental/TokenNode.uxml")
        {
            AddStyleSheetPath("StyleSheets/GraphViewExperimental/TokenNode.uss");
