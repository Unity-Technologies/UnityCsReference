...
namespace UnityEditor.Experimental.UIElements.GraphView
{
    public partial class Scope : GraphElement
    {
        ...
        public Scope()
        {
            var visualTree = EditorGUIUtility.Load("UXML/GraphViewExperimental/Scope.uxml") as VisualTreeAsset;

            AddStyleSheetPath("StyleSheets/GraphViewExperimental/Scope.uss");
