...
namespace UnityEditor.Experimental.UIElements.GraphView
{
    public partial class Group : Scope
    {
        ...
        public Group()
        {
            AddStyleSheetPath("StyleSheets/GraphViewExperimental/Group.uss");

            m_DropArea = new GroupDropArea();
            m_DropArea.ClearClassList();
            m_DropArea.name = "dropArea";

            var visualTree = EditorGUIUtility.Load("UXML/GraphViewExperimental/GroupTitle.uxml") as VisualTreeAsset;
