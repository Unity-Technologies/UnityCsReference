...
namespace UnityEditor
{
    ...
    public sealed partial class AudioImporter : AssetImporter
    {
        ...
        public bool ContainsSampleSettingsOverride(string platform)
        {
            ...
            return ValidatePlatform(platform, "AudioImporter.ContainsSampleSettingsOverride", out platformGroup) ?
        ...
        {
            BuildTargetGroup platformGroup;
            return ValidatePlatform(platform, "AudioImporter.GetOverrideSampleSettings", out platformGroup) ?
        ...
        {
            BuildTargetGroup platformGroup;
            return ValidatePlatform(platform, "AudioImporter.SetOverrideSampleSettings", out platformGroup) ?
        ...
        {
            BuildTargetGroup platformGroup;
            return ValidatePlatform(platform, "AudioImporter.ClearSampleSettingOverride", out platformGroup) ?
