...
namespace UnityEditor.Experimental.AssetImporters
{
    public class FBXMaterialDescriptionPreprocessor : AssetPostprocessor
    {
        ...
        public void OnPreprocessMaterialDescription(MaterialDescription description, Material material, AnimationClip[] clips)
        {
            ...
            if (lowerCaseExtension == ".fbx" || lowerCaseExtension == ".obj" || lowerCaseExtension == ".blend" || lowerCaseExtension == ".mb" || lowerCaseExtension == ".ma" || lowerCaseExtension == ".max" || lowerCaseExtension == ".dae")
            {
