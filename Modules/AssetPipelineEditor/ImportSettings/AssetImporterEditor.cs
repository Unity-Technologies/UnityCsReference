...
namespace UnityEditor.AssetImporters
{
    ...
    public abstract partial class AssetImporterEditor : Editor
    {
        ...
        public virtual void OnEnable()
        {
            ...
            // Target-dependent initialization below would either dereference a dangling InstanceId
            ...
            if (!AreImporterTargetsValid())
            {
                ...
                m_TargetsInstanceID = new List<int>();
        ...
        // throws SerializedObjectNotCreatableException and native code dereferences a stale InstanceId.
