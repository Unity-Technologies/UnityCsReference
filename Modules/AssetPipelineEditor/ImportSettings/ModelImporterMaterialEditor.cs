...
#pragma warning restore 618
        ...
        void DoMaterialRemapList()
        {
            ...
            for (int materialIdx = 0; materialIdx < m_MaterialsCache.Count; ++materialIdx)
            {
                ...
                bool hasMatchingCachedObject = m_ExternalObjectsCache.TryGetValue(new Tuple<string, string>(mat.name, mat.type), out cachedExternalObject) && cachedExternalObject != null;
