...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal class PackageDetailsLinks : VisualElement
    {
        ...
        private void ViewDocClick()
        {
            ...
            ViewUrl(UpmPackageDocs.GetDocumentationUrl(packageInfo, m_Version != null && m_Version.HasTag(PackageTag.Unity)), UpmPackageDocs.GetOfflineDocumentation(m_IOProxy, packageInfo), L10n.Tr("documentation"), "viewDocs");
        }

        private void ViewChangelogClick()
        {
            var packageInfo = m_Version != null ? m_UpmCache.GetBestMatchPackageInfo(m_Version.name, m_Version.isInstalled, m_Version.versionString) : null;
            UpmPackageDocs.ViewUrl(UpmPackageDocs.GetChangelogUrl(packageInfo, m_Version != null && m_Version.HasTag(PackageTag.Unity)), UpmPackageDocs.GetOfflineChangelog(m_IOProxy, packageInfo), L10n.Tr("changelog"), "viewChangelog", m_Version, m_Package, m_Application);
        }

        private void ViewLicensesClick()
        {
            var packageInfo = m_Version != null ? m_UpmCache.GetBestMatchPackageInfo(m_Version.name, m_Version.isInstalled, m_Version.versionString) : null;
            UpmPackageDocs.ViewUrl(UpmPackageDocs.GetLicensesUrl(packageInfo, m_Version != null && m_Version.HasTag(PackageTag.Unity)), UpmPackageDocs.GetOfflineLicenses(m_IOProxy, packageInfo), L10n.Tr("license documentation"), "viewLicense", m_Version, m_Package, m_Application);
        }
