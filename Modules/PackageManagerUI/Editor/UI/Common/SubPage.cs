...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal class SubPage
    {
        ...
        public SubPage(PackageFilterTab tab, string name, string displayName, int priority, Func<IPackage, bool> filter = null, Func<IPackage, string> getGroupName = null, Func<string, string, int> compareGroup = null)
        {
            this.tab = tab;
            this.name = name;
