...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal class SampleDetailsHeader: VisualElement
    {
        ...
        public SampleDetailsHeader(IResourceLoader resourceLoader, IApplicationProxy applicationProxy, IIOProxy ioProxy, IPackageManagerWindowProxy packageManagerWindowProxy)
        {
        ...
        {
            var importAction = new ImportSampleAction(m_Application, m_IOProxy);
