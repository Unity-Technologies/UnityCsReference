...
{
    protected override string titleText => L10n.Tr("Source", null);
    ...
    public override void Refresh(IPackageVersion version)
    {
        ...
        string source;
        string registryLink;
        var verifiedIconTooltip = L10n.Tr("This package comes from a verified source.", null);
        ...
        {
            source = L10n.Tr("Unity Technologies", null);
        ...
        {
            source = L10n.Tr("Asset Store", null);
