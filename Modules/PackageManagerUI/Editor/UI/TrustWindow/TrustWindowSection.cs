...
namespace UnityEditor.PackageManager.UI.Internal
{
    ...
    {
        public TrustWindowSection(IResourceLoader resourceLoader, TrustWindow.SectionData sectionData)
        {
        ...
        private void BindVersionCell(TrustWindow.RowData row, Label label)
        {
