...
namespace UnityEditor.PackageManager.UI
{
    internal class PackageDetails : VisualElement
    {
        ...
        public PackageDetails()
        {
            ...
            downgradeButton.Status = DropdownStatus.Warning;
        ...
        private void RefreshButtonStatusAndTooltip(Button button, PackageAction action, params ButtonDisableCondition[] disableConditions)
        {
