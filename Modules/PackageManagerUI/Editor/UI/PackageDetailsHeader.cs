...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal class PackageDetailsHeader : VisualElement
    {
        ...
        {
            var featurePackageInfo = m_Package.Is(PackageType.Feature) && m_Version != null ? m_UpmCache.GetBestMatchPackageInfo(m_Version.name, m_Version.isInstalled, m_Version.versionString) : null;
        ...
        private void RefreshScopedRegistryInfoBox()
        {
            if (m_Version.availableRegistry == RegistryType.MyRegistries)
            {
            ...
            {
                UIUtils.SetElementDisplay(scopedRegistryInfoBox, false);
            }
        }
