...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal partial class PackageFactory
    {
        ...
        private IPackage CreateUpmOnAssetStorePackage(long productId, string packageName, AssetStoreProductInfo productInfo, AssetStorePurchaseInfo purchaseInfo, IUpmPackageData packageData, PackagesChangedSource changedSource)
        {
