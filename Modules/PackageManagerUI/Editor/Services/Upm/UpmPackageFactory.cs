...
namespace UnityEditor.PackageManager.UI.Internal
{
    internal partial class PackageFactory
    {
        ...
        {
            var allPackageNames = m_UpmCache.installedPackageInfos.Concat(m_UpmCache.discoverableSearchPackageInfos).Concat(m_UpmCache.nonDiscoverableSearchPackageInfos).Select(p => p.name).ToHashSet();
