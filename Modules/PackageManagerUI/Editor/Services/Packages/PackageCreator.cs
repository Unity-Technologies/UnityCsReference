...
internal class PackageCreator : BaseService<IPackageCreator>, IPackageCreator
{
    ...
    public static readonly string k_GeneralExceptionConsoleErrorMessage = L10n.Tr("An error occurred while trying to create the new package.", null);
    public static readonly string k_TempAndPackagesFolderAreReadOnlyConsoleErrorMessage = L10n.Tr("An error occurred while trying to create the new package. The project contains read-only folders ('Temp' and 'Packages'). Change the permissions to read and write and try again.", null);
    public static readonly string k_TempFolderIsReadOnlyConsoleErrorMessage = L10n.Tr("An error occurred while trying to create the new package. The 'Temp' folder in the project is a read-only folder. Change the permissions to read and write and try again.", null);
    public static readonly string k_PackagesFolderIsReadOnlyConsoleErrorMessage = L10n.Tr("An error occurred while trying to create the new package. The 'Packages' folder in the project is a read-only folder. Change the permissions to read and write and try again.", null);
    ...
    public static readonly string k_PathIsTooLongConsoleErrorMessage = L10n.Tr("An error occurred while trying to create the new package. The path to your project might be too long. Move your project to another location with a shorter path, then try again.", null);

    public static readonly string k_NameIsTooLongUiErrorMessage = L10n.Tr("The package display name is too long.", null);
    public static readonly string k_GeneralExceptionUiErrorMessage = L10n.Tr("An error occured while creating the package. See console for more details.", null);
