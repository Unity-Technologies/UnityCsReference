...
namespace UnityEditor.PackageManager.UI.Internal
{
    ...
    internal class FetchStatusTracker : BaseService<IFetchStatusTracker>, IFetchStatusTracker, ISerializationCallbackReceiver
    {
        ...
        {
            m_SerializedProductIds = m_ProductInfoFetchStatuses.Keys.ToArray();
            m_SerializedProductInfoFetchStatuses = m_ProductInfoFetchStatuses.Values.ToArray();

            m_SerializedPackageNames = m_SearchInfoFetchStatuses.Keys.ToArray();
            m_SerializedSearchInfoFetchStatuses = m_SearchInfoFetchStatuses.Values.ToArray();
        }
