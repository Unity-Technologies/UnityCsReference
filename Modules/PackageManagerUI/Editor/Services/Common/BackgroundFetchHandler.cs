    ...
    internal class BackgroundFetchHandler : BaseService<IBackgroundFetchHandler>, IBackgroundFetchHandler, ISerializationCallbackReceiver
    {
        ...
        public void OnBeforeSerialize()
        {
            ...
            m_SerializedFetchProductInfoQueue = m_FetchProductInfoInProgress
                .Concat(m_FetchProductInfoQueue.Where(id => m_ProductInfosToFetch.Remove(id))).ToArray();

            m_SerializedSearchNonDiscoverableQueue = m_SearchNonDiscoverableInProgress.Concat(m_SearchNonDiscoverableQueue).ToArray();
