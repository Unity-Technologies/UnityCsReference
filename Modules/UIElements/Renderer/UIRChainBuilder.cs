...
namespace UnityEngine.UIElements.UIR
{
    ...
    internal class RenderChain : IDisposable
    {
        struct DepthOrderedDirtyTracking // Depth then register-time order
        {
            ...
            public void RegisterDirty(VisualElement ve, RenderDataDirtyTypes dirtyTypes)
            {
        ...
        public void Render(Rect topRect, Matrix4x4 projection)
        {
            ...
            for (int depth = m_DirtyTracker.minDepth; depth <= m_DirtyTracker.maxDepth; depth++)
            {
        ...
        public void UIEOnTransformOrSizeChanged(VisualElement ve, bool transformChanged, bool sizeChanged)
        {
            if (ve.renderChainData.isInChain)
            {
                ...
                m_DirtyTracker.RegisterDirty(ve, flags);
            }
        }
        ...
        public void UIEOnClippingChanged(VisualElement ve, bool hierarchical)
        {
            if (ve.renderChainData.isInChain)
            {
                ...
                m_DirtyTracker.RegisterDirty(ve, RenderDataDirtyTypes.Clipping | (hierarchical ? RenderDataDirtyTypes.ClippingHierarchy : 0));
            }
        }
        ...
        public void UIEOnVisualsChanged(VisualElement ve, bool hierarchical)
        {
            if (ve.renderChainData.isInChain)
            {
                ...
                m_DirtyTracker.RegisterDirty(ve, RenderDataDirtyTypes.Visuals | (hierarchical ? RenderDataDirtyTypes.VisualsHierarchy : 0));
            }
        }
