...
using StyleValueHandle = UnityEngine.UIElements.StyleValueHandle;
using StyleSheet = UnityEngine.UIElements.StyleSheet;
using StyleValueKeyword = UnityEngine.UIElements.StyleValueKeyword;
using StyleValueType = UnityEngine.UIElements.StyleValueType;
...
namespace UnityEngine.Experimental.UIElements.StyleSheets
{
    ...
    internal class VisualElementStylesData : ICustomStyle
    {
        ...
        internal void ApplyRule(StyleSheet registry, int specificity, StyleRule rule, StylePropertyID[] propertyIDs)
        {
            ...
            {
                UnityEngine.UIElements.StyleProperty styleProperty = rule.properties[i];
