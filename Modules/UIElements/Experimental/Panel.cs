...
using IDataWatchService = UnityEngine.UIElements.IDataWatchService;
...
namespace UnityEngine.Experimental.UIElements
{
    ...
    internal delegate UnityEngine.UIElements.ISerializableJsonDictionary GetViewDataDictionary();
