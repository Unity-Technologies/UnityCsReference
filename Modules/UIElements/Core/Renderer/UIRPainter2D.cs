...
namespace UnityEngine.UIElements
{
    ...
    public class Painter2D : IDisposable
    {
        ...
        private static readonly ProfilerMarker s_ClipMarker = new ProfilerMarker("Painter2D.Clip");
        ...
        /// <remarks>
        /// <para>
        /// For performance reasons, this only works for Painter2D instances created with "new Painter2D()" to be eventually saved
        /// to a VectorImage using <see cref="SaveToVectorImage(VectorImage)"/>. This will not work with Painter2D attached to a
        /// <see cref="MeshGenerationContext"/>.
        /// </para>
        /// <para>
