...
{
    sealed class MeshManagerMapped : MeshManager
    {
        GpuUpdaterMapped<Vertex> m_VertexUpdater = new();
        GpuUpdaterMapped<ushort> m_IndexUpdater = new();
        ...
        public MeshManagerMapped(uint initialVertexCapacity, uint initialIndexCapacity) : base(initialVertexCapacity, initialIndexCapacity, true)
        {
        ...
        public override void OnFrameRenderingBegin()
        {
            ...
            while (page != null)
            {
                m_VertexUpdater.SendChanges(page.vertices);
                m_IndexUpdater.SendChanges(page.indices);
                page = page.next;
            }
        }
