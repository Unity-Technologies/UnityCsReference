...
namespace UnityEngine.UIElements
{
    internal partial class ResolvedStyleAccessPropertyBag
    {
        ...
        class OverflowProperty : ResolvedEnumProperty<Overflow>
        {
            public override string Name => nameof(IResolvedStyle.overflow);
            public override string ussName => "overflow";
            public override bool IsReadOnly => true;

            public override Overflow GetValue(ref ResolvedStyleAccess container) => ((IResolvedStyle)container).overflow;
            public override void SetValue(ref ResolvedStyleAccess container, Overflow value) => throw new System.InvalidOperationException();
        }
        ...
        class UnityCurvatureProperty : ResolvedCurvatureProperty
        {
            public override string Name => nameof(IResolvedStyle.unityCurvature);
            public override string ussName => "-unity-curvature";
            public override bool IsReadOnly => true;

            public override Curvature GetValue(ref ResolvedStyleAccess container) => ((IResolvedStyle)container).unityCurvature;
            public override void SetValue(ref ResolvedStyleAccess container, Curvature value) => throw new System.InvalidOperationException();
        }
        ...
        {
            m_PropertiesList = new List<IProperty<ResolvedStyleAccess>>(103);
            m_PropertiesHash = new Dictionary<string, IProperty<ResolvedStyleAccess>>(309);
