...
namespace UnityEngine.UIElements
{
    internal partial class InlineStyleAccessPropertyBag
    {
        ...
        class BackdropFilterProperty : InlineStyleListProperty<FilterFunction>
        {
            public override string Name => nameof(IStyle.backdropFilter);
            public override string ussName => "backdrop-filter";
            public override bool IsReadOnly => false;

            public override StyleList<FilterFunction> GetValue(ref InlineStyleAccess container) => ((IStyle)container).backdropFilter;
            public override void SetValue(ref InlineStyleAccess container, StyleList<FilterFunction> value) => ((IStyle)container).backdropFilter = value;
        }
        ...
        class ColumnGapProperty : InlineStyleLengthProperty
        {
            public override string Name => nameof(IStyle.columnGap);
            public override string ussName => "column-gap";
            public override bool IsReadOnly => false;

            public override StyleLength GetValue(ref InlineStyleAccess container) => ((IStyle)container).columnGap;
            public override void SetValue(ref InlineStyleAccess container, StyleLength value) => ((IStyle)container).columnGap = value;
        }
        ...
        class RowGapProperty : InlineStyleLengthProperty
        {
            public override string Name => nameof(IStyle.rowGap);
            public override string ussName => "row-gap";
            public override bool IsReadOnly => false;

            public override StyleLength GetValue(ref InlineStyleAccess container) => ((IStyle)container).rowGap;
            public override void SetValue(ref InlineStyleAccess container, StyleLength value) => ((IStyle)container).rowGap = value;
        }
        ...
        class UnityCurvatureProperty : InlineStyleCurvatureProperty
        {
            public override string Name => nameof(IStyle.unityCurvature);
            public override string ussName => "-unity-curvature";
            public override bool IsReadOnly => false;

            public override StyleCurvature GetValue(ref InlineStyleAccess container) => ((IStyle)container).unityCurvature;
            public override void SetValue(ref InlineStyleAccess container, StyleCurvature value) => ((IStyle)container).unityCurvature = value;
        }
