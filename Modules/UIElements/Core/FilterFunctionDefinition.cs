...
namespace UnityEngine.UIElements
{
    ...
    public struct PostProcessingPass
    {
        ...
        [Obsolete("This delegate will be removed. Use ApplyFilterPassSettingsDelegate instead.", true)]
        ...
        /// <summary>The optional callback to prepare the material property block for the effect.</summary>
        [Obsolete("This property will be removed. Use applySettingsCallback instead, which provides additional contextual information.", true)]
