...
namespace UnityEditor.Connect
{
    internal class InsightsProjectSettings : ServicesProjectSettings
    {
        ...
        const string k_InsightsUxmlPath = "UXML/ServicesWindow/InsightsProjectSettings.uxml";
        const string k_InsightEnabledsUxmlPath = "UXML/ServicesWindow/InsightsSettings.uxml";
        const string k_InsightsStyleSheetPath = "StyleSheets/ServicesWindow/InsightsSettings.uss";
