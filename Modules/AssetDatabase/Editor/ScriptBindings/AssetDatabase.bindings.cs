...
namespace UnityEditor
{
    ...
    public partial class AssetDatabase
    {
        ...
        private const string kPreventExecutionDuringImportHowToFixMsg_transitionalWarning = "Please make sure this function is not called from ScriptedImporters or PostProcessors, as it is a source of non-determinism. This warning will eventually become an exception.";
        ...
        [PreventExecutionInState(AssetDatabasePreventExecution.kImportingAsset, PreventExecutionSeverity.PreventExecution_Error, kPreventExecutionDuringImportHowToFixMsg)]
        ...
        [PreventExecutionInState(AssetDatabasePreventExecution.kImportingInWorkerProcess, PreventExecutionSeverity.PreventExecution_ManagedException)]
        [PreventExecutionInState(AssetDatabasePreventExecution.kImportingAsset, PreventExecutionSeverity.PreventExecution_Warning, kPreventExecutionDuringImportHowToFixMsg_transitionalWarning)]
