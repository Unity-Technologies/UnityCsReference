...
namespace UnityEditor.Build.Analysis
{
    ...
    internal static class FormatUtility
    {
        ...
        /// <summary>
        /// Format bytes into human-readable size. Negative values are clamped to zero.
        /// </summary>
        public static string FormatSize(long bytes) => FormatSize((ulong)Math.Max(0L, bytes));
