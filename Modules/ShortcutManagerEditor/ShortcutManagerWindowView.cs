...
namespace UnityEditor.ShortcutManagement
{
    class ShortcutManagerWindowView : IShortcutManagerWindowView
    {
        ...
        {
            var title = L10n.Tr("Binding Conflict", null);
            var message = string.Format(L10n.Tr("The key {0} is already assigned to the \"{1}\" shortcut.\nDo you want to reassign this key?", null), KeyCombination.SequenceToString(newBinding), conflicts[0].displayName);
            var result = EditorUtility.DisplayDialogComplex(title, message, L10n.Tr("Reassign", null), L10n.Tr("Cancel", null), L10n.Tr("Create Conflict", null));
            switch (result)
            {
                case 0:
        ...
        void BindShortcutEntryItem(VisualElement shortcutElementTemplate, int index)
        {
            ...
            var shortcutTypeElementTooltip = L10n.Tr("An action shortcut triggers once when the binding for the shortcut is activated. " +
                ...
                "A menu shortcut is associated with a menu item.", null);
...
#pragma warning restore UAC2010
        ...
        void OnCreateProfileClicked()
        {
            ...
            PromptWindow.Show(L10n.Tr("Create Profile", null),
                L10n.Tr("Create a shortcut profile", null),
                L10n.Tr("Enter the name of the profile you want to create", null),
                L10n.Tr("Profile Name", null),
                L10n.Tr(newProfileName, null),
                L10n.Tr("Create", null),
        ...
        {
            PromptWindow.Show(L10n.Tr("Rename Profile", null),
                L10n.Tr("Rename a shortcut profile", null),
                string.Format(L10n.Tr("Enter the new name you want to give the profile '{0}'", null), m_ViewController.activeProfile),
                L10n.Tr("Profile Name", null),
        ...
        {
            var importPath = EditorUtility.OpenFilePanel(L10n.Tr("Import Profile", null), "", "json");
        ...
        void OnExportProfileClicked(ClickEvent evt)
        {
            ...
            {
                EditorUtility.DisplayDialog(L10n.Tr("No Profile", null),
                    L10n.Tr($"The \"{m_ViewController.activeProfile}\" profile contains no shortcut overrides so there is nothing to export.\n\nCreate a new profile with shortcut key overrides and try again.", null),
                    L10n.Tr("OK", null));
                return;
            }

            var exportPath = EditorUtility.SaveFilePanel(L10n.Tr("Export Profile", null), "", m_ViewController.activeProfile, "json");
        ...
        void BuildLegendRow(VisualElement root)
        {
            ...
            var labels = new[] { L10n.Tr("Unassigned Key", null), L10n.Tr("Assigned Key", null), L10n.Tr("Global Key", null), L10n.Tr("Mixed Key", null) };
        ...
        {
            m_Root.Q<TextElement>("categoryTableHeaderName").text = L10n.Tr("Category", null);
            m_Root.Q<TextElement>("shortcutsTableHeaderName").text = L10n.Tr("Command", null);
            m_Root.Q<TextElement>("shortcutsTableHeaderContext").text = L10n.Tr("Context", null);
            m_Root.Q<TextElement>("shortcutsTableHeaderType").text = L10n.Tr("Type", null);
            m_Root.Q<TextElement>("shortcutsTableHeaderBindings").text = L10n.Tr("Shortcut", null);
            m_Root.Q<TextElement>("searchLabel").text = L10n.Tr("Search:", null);
        }
...
#pragma warning restore UAC2002
            ...
            foreach (var entry in entries)
            {
                ...
                if (entry.overridden)
                    menu.AddItem(new GUIContent($"{rootItemLabel}/{L10n.Tr("Reset to default", null)}"), false, (x) =>
                    {
                        m_ViewController.ResetToDefault(entry);
                        RefreshListSelection();
                    }, entry);
                else
                    menu.AddDisabledItem(new GUIContent($"{rootItemLabel}/{L10n.Tr("Reset to default", null)}"));
                menu.AddItem(new GUIContent($"{rootItemLabel}/{L10n.Tr("Remove shortcut", null)}"), false, (x) =>
                {
