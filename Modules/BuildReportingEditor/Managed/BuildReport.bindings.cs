...
namespace UnityEditor.Build.Reporting
{
    ...
    public sealed class BuildReport : Object
    {
        ...
        ///<remarks>Contains every file the build wrote, including the files packed inside Unity archive files. The returned array is a copy and this method execution length scales linearly with number of files.</remarks>
        ...
        ///<remarks>Contains information such as the overall result, target platform, timing, and total sizes of the build. `BuildReportSummary.json` contains a subset of this data.</remarks>
...
#pragma warning restore UA2001
        ...
        ///<remarks>Contains a per-object breakdown of each serialized file. For Player and AssetBundle builds only. Unity omits `packedAssets` from content directory builds to save disk space, because `ContentLayout.json` and <see cref="contentSummary" /> conveys similar information in a more compact form.</remarks>
