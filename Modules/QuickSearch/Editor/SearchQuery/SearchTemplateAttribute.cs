...
namespace UnityEditor.Search
{
    class SearchTemplateAttribute : Attribute
    {
        ...
        public SearchViewFlags viewFlags { get; set; }

        private Func<IEnumerable<string>> multiEntryHandler;

        public SearchTemplateAttribute(string description = null, string providerId = null, SearchViewFlags viewFlags = SearchViewFlags.None)
        {
