...
{
    internal struct StructNode : IEquatable<StructNode>, ISyntaxNode<StructNode>
    {
        ...
        internal struct InternalNode
        {
            ...
            // FunctionNode or StructFieldNode
        ...
        [FreeFunction("ShaderFoundry::BlockParser::BlittabilityCheck<ShaderFoundry::BlockParser::StructNode>")]
        ...
        // IEquality Interface
        public override bool Equals(object obj) => obj is StructNode other && this.Equals(other);
        public bool Equals(StructNode other) => syntaxTree == other.syntaxTree && handle == other.handle;
        public override int GetHashCode() => (syntaxTree, handle).GetHashCode();
        public static bool operator ==(StructNode lhs, StructNode rhs) => lhs.Equals(rhs);
        public static bool operator !=(StructNode lhs, StructNode rhs) => !lhs.Equals(rhs);
        ...
        internal StructNode(SyntaxTree syntaxTree, NodeHandle handle)
        {
        ...
        public class Builder : BaseBuilder
        {
            ...
            public void Add(StructFieldNode node) => AddInternal(node);
            ...
            {
                var node = new StructNode(syntaxTree, syntaxTree.AllocateByNodeType(InternalNode.kNodeType));
