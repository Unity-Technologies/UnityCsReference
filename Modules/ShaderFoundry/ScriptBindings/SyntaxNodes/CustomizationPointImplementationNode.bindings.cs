...
{
    internal struct CustomizationPointImplementationNode : IEquatable<CustomizationPointImplementationNode>, ISyntaxNode<CustomizationPointImplementationNode>
    {
        ...
        [FreeFunction("ShaderFoundry::BlockParser::BlittabilityCheck<ShaderFoundry::BlockParser::CustomizationPointImplementationNode>")]
        ...
        // IEquality Interface
        public override bool Equals(object obj) => obj is CustomizationPointImplementationNode other && this.Equals(other);
        public bool Equals(CustomizationPointImplementationNode other) => syntaxTree == other.syntaxTree && handle == other.handle;
        public override int GetHashCode() => (syntaxTree, handle).GetHashCode();
        public static bool operator ==(CustomizationPointImplementationNode lhs, CustomizationPointImplementationNode rhs) => lhs.Equals(rhs);
        public static bool operator !=(CustomizationPointImplementationNode lhs, CustomizationPointImplementationNode rhs) => !lhs.Equals(rhs);
        ...
        internal CustomizationPointImplementationNode(SyntaxTree syntaxTree, NodeHandle handle)
        {
        ...
        public class Builder : BaseBuilder
        {
            ...
            public CustomizationPointImplementationNode Build()
            {
                var node = new CustomizationPointImplementationNode(syntaxTree, syntaxTree.AllocateByNodeType(InternalNode.kNodeType));
