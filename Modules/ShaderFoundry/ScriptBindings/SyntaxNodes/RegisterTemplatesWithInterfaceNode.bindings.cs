...
{
    internal struct RegisterTemplatesWithInterfaceNode : IEquatable<RegisterTemplatesWithInterfaceNode>, ISyntaxNode<RegisterTemplatesWithInterfaceNode>
    {
        ...
        internal struct InternalNode
        {
            ...
            internal NodeList statementHandles; // List<RegisterTemplatestatementNodeHandle>
        }
        ...
        [FreeFunction("ShaderFoundry::BlockParser::BlittabilityCheck<ShaderFoundry::BlockParser::RegisterTemplatesWithInterfaceNode>")]
        ...
        // IEquality Interface
        public override bool Equals(object obj) => obj is RegisterTemplatesWithInterfaceNode other && this.Equals(other);
        public bool Equals(RegisterTemplatesWithInterfaceNode other) => syntaxTree == other.syntaxTree && handle == other.handle;
        public override int GetHashCode() => (syntaxTree, handle).GetHashCode();
        public static bool operator ==(RegisterTemplatesWithInterfaceNode lhs, RegisterTemplatesWithInterfaceNode rhs) => lhs.Equals(rhs);
        public static bool operator !=(RegisterTemplatesWithInterfaceNode lhs, RegisterTemplatesWithInterfaceNode rhs) => !lhs.Equals(rhs);
        ...
        internal IEnumerable<RegisterTemplateStatementNode> Statements =>
            syntaxTree.EnumerateSyntaxNodes<RegisterTemplateStatementNode>(NodeRef.statementHandles);

        internal RegisterTemplatesWithInterfaceNode(SyntaxTree syntaxTree, NodeHandle handle)
        {
        ...
        public class Builder : BaseBuilder
        {
            ...
            List<RegisterTemplateStatementNode> m_Statements = new List<RegisterTemplateStatementNode>();
            ...
            public IEnumerable<RegisterTemplateStatementNode> Statements => m_Statements;
            public void AddAttribute(AttributeNode node) => m_Attributes.Add(Validate(node));
            public void AddStatement(RegisterTemplateStatementNode node) => m_Statements.Add(Validate(node));
            ...
            public RegisterTemplatesWithInterfaceNode Build()
            {
                var node = new RegisterTemplatesWithInterfaceNode(syntaxTree, syntaxTree.AllocateByNodeType(InternalNode.kNodeType));
