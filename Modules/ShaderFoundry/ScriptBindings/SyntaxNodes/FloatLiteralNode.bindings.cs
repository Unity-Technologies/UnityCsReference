...
{
    internal struct FloatLiteralNode : IEquatable<FloatLiteralNode>, ISyntaxNode<FloatLiteralNode>
    {
        ...
        [FreeFunction("ShaderFoundry::BlockParser::BlittabilityCheck<ShaderFoundry::BlockParser::FloatingLiteralNode>")]
        ...
        // IEquality Interface
        public override bool Equals(object obj) => obj is FloatLiteralNode other && this.Equals(other);
        public bool Equals(FloatLiteralNode other) => syntaxTree == other.syntaxTree && handle == other.handle;
        public override int GetHashCode() => (syntaxTree, handle).GetHashCode();
        public static bool operator ==(FloatLiteralNode lhs, FloatLiteralNode rhs) => lhs.Equals(rhs);
        public static bool operator !=(FloatLiteralNode lhs, FloatLiteralNode rhs) => !lhs.Equals(rhs);

        // Node Interface
        internal bool IsValid => handle.IsValid;
        ref InternalNode NodeRef => ref syntaxTree.GetNodeRef<InternalNode>(nodePtr);
        internal double Value => NodeRef.value;
        internal TextRange SourceRange => NodeRef.sourceRange;

        internal FloatLiteralNode(SyntaxTree syntaxTree, NodeHandle handle)
        {
        ...
        public class Builder : BaseBuilder
        {
            ...
            public Builder(SyntaxTree syntaxTree, double value)
                : base(syntaxTree)
            {
                Value = value;
            }
            public FloatLiteralNode Build()
            {
                var node = new FloatLiteralNode(syntaxTree, syntaxTree.AllocateByNodeType(InternalNode.kNodeType));
