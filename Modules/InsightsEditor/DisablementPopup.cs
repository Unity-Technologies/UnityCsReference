...
{
    const string k_TemplatePath = "UXML/ServicesWindow/InsightsDisablementPopup.uxml";
    const string k_StylePath = "StyleSheets/ServicesWindow/InsightsDisablementPopup.uss";
