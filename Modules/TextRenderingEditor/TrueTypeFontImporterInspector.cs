...
namespace UnityEditor
{
    ...
    internal class TrueTypeFontImporterInspector : AssetImporterEditor
    {
        ...
        {
            public static readonly GUIContent RenderingMode = L10n.TextContent("Rendering Mode", null, null, null);
            public static readonly GUIContent TextureCase = L10n.TextContent("Character", null, null, null);
            public static readonly GUIContent AscentCalculationMode = L10n.TextContent("Ascent Calculation Mode", null, null, null);
            public static readonly GUIContent CustomChars = L10n.TextContent("Custom Chars", null, null, null);
            public static readonly GUIContent BoundCalculation = L10n.TextContent("Use Legacy Bounds", null, null, null);
            public static readonly GUIContent ShouldRoundAdvanceValue = L10n.TextContent("Should Round Advance Value", null, null, null);
            public static readonly GUIContent IncludeFontData = L10n.TextContent("Include Font Data", null, null, null);
            public static readonly GUIContent FamilyName = L10n.TextContent("Family Name", "This is the family name of this font. It will always be included to perform the references check, along with other names in the Font Name list.", null, null);
            public static readonly GUIContent FontName = L10n.TextContent("Font Names", null, null, null);
            public static readonly GUIContent FontReferences = L10n.TextContent("References to other fonts in project", null, null, null);
            public static readonly GUIContent NoFontReference = L10n.TextContent("No references to other fonts in project.", null, null, null);

            public static readonly string FormatUnsupported = L10n.Tr("Format of selected font is not supported by Unity.", null);
            public static readonly string ReferencesInformation = L10n.Tr("These are automatically generated by the inspector if any of the font names you supplied match fonts present in your project, which will then be used as fallbacks for this font.", null);
        }
