...
namespace UnityEngine.LowLevelPhysics2D
{
    ...
    {
        /// <summary>
        /// Get a <see cref="LowLevelPhysics2D.PhysicsMask"/> for the specified layer name(s).
        /// </summary>
        /// <param name="layerNames">The layer names (case sensitive) to find a combined physics mask for.</param>
        /// <returns>The combined physics mask associated with the specified layer names or, if not found, <see cref="LowLevelPhysics2D.PhysicsMask.None"/> will be returned in which case a console warning will also be produced.</returns>
        ...
        public static PhysicsMask GetLayerMask(params string[] layerNames)
        {
            ...
            if (PhysicsWorld.useFullLayers && PhysicsGlobal_GetPhysicsLayers() is LayerNames physicsLayerNames)
            {
        ...
        /// <returns>The layer ordinal associated with the specified layer name or, if not found, <see cref="LowLevelPhysics2D.PhysicsLayers.InvalidLayerOrdinal"/> will be returned in which case a console warning will also be produced.</returns>
