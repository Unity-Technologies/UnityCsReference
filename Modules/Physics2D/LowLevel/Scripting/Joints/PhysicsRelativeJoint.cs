...
namespace UnityEngine.LowLevelPhysics2D
{
    ...
    public readonly struct PhysicsRelativeJoint : IPhysicsJoint, IEquatable<PhysicsRelativeJoint>
    {
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsRelativeJoint joint) => joint.m_Id;

        /// <summary>
        /// Cast to a <see cref="LowLevelPhysics2D.PhysicsRelativeJoint"/> from the base <see cref="LowLevelPhysics2D.PhysicsJoint"/>.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.RelativeJoint"/>.
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="LowLevelPhysics2D.PhysicsRelativeJoint"/> from the specified base joint.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.RelativeJoint"/>.
        /// </summary>
        /// <param name="physicsJoint">The base joint to cast.</param>
        /// <exception cref="InvalidCastException">Thrown if the joint type is invalid.</exception>
        ...
        /// <undoc/>
        public bool Equals(PhysicsRelativeJoint other) => m_Id.Equals(other);
        ...
        /// </summary>
        /// <param name="ownerKey">The owner key returned when using <see cref="LowLevelPhysics2D.PhysicsJoint.SetOwner(Object)"/>.</param>
        ...
        /// </summary>
        public float forceThreshold { get => m_Id.forceThreshold; set => m_Id.forceThreshold = value; }

        /// <summary>
        /// The torque threshold beyond which a joint event will be produced.
        /// </summary>
        public float torqueThreshold { get => m_Id.torqueThreshold; set => m_Id.torqueThreshold = value; }
