...
namespace UnityEngine.LowLevelPhysics2D
{
    ...
    public readonly struct PhysicsSliderJoint : IPhysicsJoint, IEquatable<PhysicsSliderJoint>
    {
        ...
        /// <summary>
        /// Cast to a <see cref="LowLevelPhysics2D.PhysicsSliderJoint"/> from the base <see cref="LowLevelPhysics2D.PhysicsJoint"/>.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.SliderJoint"/>.
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="LowLevelPhysics2D.PhysicsSliderJoint"/> from the specified base joint.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.SliderJoint"/>.
        /// </summary>
        /// <param name="physicsJoint">The base joint to cast.</param>
        /// <exception cref="InvalidCastException">Thrown if the joint type is invalid.</exception>
