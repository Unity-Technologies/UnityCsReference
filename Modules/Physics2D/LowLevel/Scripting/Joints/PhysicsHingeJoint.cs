...
namespace UnityEngine.LowLevelPhysics2D
{
    ...
    public readonly struct PhysicsHingeJoint : IPhysicsJoint, IEquatable<PhysicsHingeJoint>
    {
        ...
        /// <summary>
        /// Cast to a <see cref="LowLevelPhysics2D.PhysicsHingeJoint"/> from the base <see cref="LowLevelPhysics2D.PhysicsJoint"/>.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.HingeJoint"/>.
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="LowLevelPhysics2D.PhysicsHingeJoint"/> from the specified base joint.
        /// The provided joint must be a joint type of <see cref="LowLevelPhysics2D.PhysicsJoint.JointType.HingeJoint"/>.
        /// </summary>
        /// <param name="physicsJoint">The base joint to cast.</param>
        /// <exception cref="InvalidCastException">Thrown if the joint type is invalid.</exception>
        ...
        /// <summary>
        /// The desired motor speed, usually in in degrees per second.
        /// </summary>
