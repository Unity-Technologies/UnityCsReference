...
{
    /// <summary>
    /// A <see cref="LowLevelPhysics2D.PhysicsBody"/> definition used to specify important initial properties.
    /// </summary>
    [Serializable]
    ...
    public struct PhysicsBodyDefinition
    {
        ...
        /// <summary>
        /// Get a default <see cref="LowLevelPhysics2D.PhysicsBody"/> definition.
        /// </summary>
        ...
        /// <summary>
        /// A speed threshold below which the body is allowed to sleep.
        /// </summary>
