...
namespace Unity.PlayMode.Editor
{
    class PlayModeButtonsView : VisualElement
    {
            ...
            if (playModeStateChange == PlayModeStateChange.EnteredPlayMode)
            {
                EditorApplication.delayCall += () =>
                {
                    ...
                    if (PlayModeManager.instance.CurrentState != PlayModeState.Running &&
                        PlayModeManager.instance.ActivePlayModeConfig.GetType() != typeof(DefaultPlayModeConfiguration))
                    {
                        Debug.LogWarning(
        ...
        void ValidateCurrentConfiguration(PlayModeConfiguration currentConfig)
        {
