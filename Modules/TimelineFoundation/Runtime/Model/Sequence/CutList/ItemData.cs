...
namespace Unity.Timeline.Foundation.Model.Internals
{
    ...
    {
        [NoAutoStaticsCleanup] // immutable invalid-sentinel; all members are invalid IDs/zero times and a default (null-content) payload
        public static readonly ItemData Invalid = new ItemData
        {
            id = UniqueID.Invalid,
