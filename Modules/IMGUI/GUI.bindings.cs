...
namespace UnityEngine
{
    ...
    partial class GUI
    {
        ...
        private static extern Rect Internal_DoModalWindow(int id, int instanceID, Rect clientRect, WindowFunction func, GUIContent content, [UnityMarshalAs(NativeType.ScriptingObjectPtr)] GUIStyle style, System.Object skin);
        private static extern Rect Internal_DoWindow(int id, int instanceID, Rect clientRect, WindowFunction func, GUIContent title, [UnityMarshalAs(NativeType.ScriptingObjectPtr)] GUIStyle style, System.Object skin, bool forceRectOnLayout);
