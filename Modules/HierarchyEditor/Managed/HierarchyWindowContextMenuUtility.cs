...
namespace Unity.Hierarchy.Editor
{
    ...
    {
        static readonly string k_EditFolderName = L10n.Tr("Edit", null);
        static readonly string k_Cut = L10n.Tr("Cut", null);
        static readonly string k_Copy = L10n.Tr("Copy", null);
        static readonly string k_Paste = L10n.Tr("Paste", null);
        static readonly string k_PasteSpecialFolderName = L10n.Tr("Paste Special", null);
        static readonly string k_PasteAsChildKeepLocalTransform = L10n.Tr("Paste as Child (Keep Local Transform)", null);
        static readonly string k_PasteAsChildKeepWorldTransform = L10n.Tr("Paste as Child (Keep World Transform)", null);
        ...
        static readonly string k_FindReferenceInScene = L10n.Tr("Find References In Scene", null);
