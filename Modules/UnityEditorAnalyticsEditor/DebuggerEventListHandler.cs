...
{
    internal class DebuggerEventListHandler
    {
        ...
        internal static event Action<Analytic> analyticSent; // Used only by the internal window
      ...
      /*  public static DebuggerEventListHandler instance
        ...
        internal Analytic[] csharp_items = null;

        internal static void AddCSharpAnalytic(Analytic analytic)
        {
