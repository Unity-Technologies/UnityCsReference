...
namespace Unity.Loading
{
    ...
    public static partial class ContentLoadManager
    {
        ...
        /// </summary>
        /// <returns>An array of all the root assets in all registered content directories.</returns>
        ...
        /// <returns>An array of all the root assets in the specified content directory.</returns>
