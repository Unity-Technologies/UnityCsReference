...
namespace UnityEngine
{
    ...
    /*UCBP-PUBLIC*/ internal sealed class Loadable<T> where T : Object
    {
        ...
        private T m_Target;
        private L1LoadingOperation m_LoadOperation;
        ...
        public T Load()
        {
            ...
            if (m_Target == null)
            {
                m_LoadOperation = LoadableManager.LoadObjectAsync(m_LoadableRef);
        ...
        {
            // If m_LoadOperation is null, the object was released while loading was in progress.
            // In this case, return early since the release has already been handled.
            if (m_LoadOperation == null)
                return;

            Object obj = m_LoadOperation.asset;
            ...
            if (m_Target == null || obj == null)
            {
                L1UnloadOperation unloadOp = LoadableManager.ReleaseObjectAsync(m_LoadOperation.Handle);
                if (unloadOp != null)
                    unloadOp.WaitForCompletion(0);
        ...
        {
            if (m_LoadOperation != null)
                LoadableManager.ReleaseObjectAsync(m_LoadOperation.Handle);
