...
namespace Unity.U2D.Physics
{
    ...
    public struct CapsuleGeometry
    {
        ...
        /// See <see cref="CapsuleGeometry.defaultGeometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Transform the geometry.
        /// The maximum absolute value component from the scale will be used to scale the <see cref="CapsuleGeometry.radius"/>.
        /// </summary>
        /// <param name="transform">The transform to be used on the geometry.</param>
        /// <param name="scaleRadius">Whether to scale the radius of the shape.</param>
        /// <returns>The transformed geometry.</returns>
        ...
        /// <summary>
        /// Inverse-Transform the geometry.
        /// The maximum (minimum in the inverse) absolute value component from the scale will be used to scale the <see cref="CapsuleGeometry.radius"/>.
        /// </summary>
        /// <param name="transform">The transform to be used on the geometry.</param>
        /// <param name="scaleRadius">Whether to scale the radius of the shape.</param>
        /// <returns>The inverse-transformed geometry.</returns>
        ...
        /// <undoc/>
        public static implicit operator PhysicsShape.ShapeProxy(CapsuleGeometry geometry) => geometry.CreateShapeProxy();
