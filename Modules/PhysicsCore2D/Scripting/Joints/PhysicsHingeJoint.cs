...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsHingeJoint : IPhysicsJoint<PhysicsHingeJoint>, IPhysicsHandle<PhysicsHingeJoint>, IEquatable<PhysicsHingeJoint>
    {
        #region Handle
        ...
        public PhysicsHingeJoint(PhysicsHandle physicsHandle) { m_JointHandle = new PhysicsJoint(physicsHandle); }
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsHingeJoint joint) => joint.m_JointHandle;
        ...
        /// <undoc/>
        public override bool Equals(object obj) => obj is PhysicsHingeJoint other && Equals(other);

        /// <undoc/>
        public bool Equals(PhysicsHingeJoint other) => m_JointHandle.Equals(other.m_JointHandle);
