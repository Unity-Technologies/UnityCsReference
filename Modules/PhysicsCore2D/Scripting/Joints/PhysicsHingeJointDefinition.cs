...
namespace Unity.U2D.Physics
{
    ...
    public record struct PhysicsHingeJointDefinition
    {
        /// <summary>
        ...
        [SerializeField] internal bool m_EnableUnpinned;
        [SerializeField] internal bool m_EnableSpring;
        [SerializeField] internal float m_SpringTargetAngle;
        ...
        [SerializeField] [Range(-178f, 178f)] internal float m_LowerAngleLimit;
        [SerializeField] [Range(-178f, 178f)] internal float m_UpperAngleLimit;
