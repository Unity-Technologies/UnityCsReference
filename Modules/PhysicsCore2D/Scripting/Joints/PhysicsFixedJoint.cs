...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsFixedJoint : IPhysicsJoint<PhysicsFixedJoint>, IPhysicsHandle<PhysicsFixedJoint>, IEquatable<PhysicsFixedJoint>
    {
        #region Handle
        ...
        public PhysicsFixedJoint(PhysicsHandle physicsHandle) { m_JointHandle = new PhysicsJoint(physicsHandle); }
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsFixedJoint joint) => joint.m_JointHandle;
        ...
        /// <undoc/>
        public override bool Equals(object obj) => obj is PhysicsFixedJoint other && Equals(other);

        /// <undoc/>
        public bool Equals(PhysicsFixedJoint other) => m_JointHandle.Equals(other.m_JointHandle);
