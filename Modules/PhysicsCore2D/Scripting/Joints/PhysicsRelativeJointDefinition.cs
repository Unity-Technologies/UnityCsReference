...
namespace Unity.U2D.Physics
{
    ...
    public record struct PhysicsRelativeJointDefinition
    {
        /// <summary>
	    ...
	    [SerializeField] internal Vector2 m_LinearVelocity;
	    [SerializeField] internal float m_AngularVelocity;
	    [SerializeField] [Min(0.0f)] internal float m_MaxForce;
	    [SerializeField] [Min(0.0f)] internal float m_MaxTorque;
	    [SerializeField] [Min(0.0f)] internal float m_SpringLinearFrequency;
	    [SerializeField] [Min(0.0f)] internal float m_SpringAngularFrequency;
	    [SerializeField] [Min(0.0f)] internal float m_SpringLinearDamping;
	    [SerializeField] [Min(0.0f)] internal float m_SpringAngularDamping;
	    [SerializeField] [Min(0.0f)] internal float m_SpringMaxForce;
	    [SerializeField] [Min(0.0f)] internal float m_SpringMaxTorque;
