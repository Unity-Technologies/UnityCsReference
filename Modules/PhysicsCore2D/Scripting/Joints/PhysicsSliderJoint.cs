...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsSliderJoint : IPhysicsJoint, IEquatable<PhysicsSliderJoint>
    {
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsSliderJoint joint) => joint.m_Id;
        ...
        /// <undoc/>
        public bool Equals(PhysicsSliderJoint other) => m_Id.Equals(other);
