...
namespace Unity.U2D.Physics
{
    ...
    public readonly partial struct PhysicsWorld : IEquatable<PhysicsWorld>
    {
        ...
        public struct ExplosionDefinition
        {
            ...
            /// The magnitude is clamped to 100000; larger magnitudes have no useful effect because body speeds are capped each simulation step.
            /// </summary>
            public float impulsePerLength { readonly get => m_ImpulsePerLength; set => m_ImpulsePerLength = Mathf.Clamp(value, -100000f, 100000f); }
        ...
        public struct WorldCapacity
        {
            ...
            /// </summary>
            internal const int MaxCapacity = ushort.MaxValue;

            /// <summary>
            /// The expected number of static shapes, in the range zero to 65535.
        ...
        /// Peaks are not capped, so a peak above 65535 is clamped to that maximum when used to presize another world.
        /// </summary>
        /// <remarks>
