...
namespace Unity.U2D.Physics
{
    ...
    public readonly partial struct PhysicsQuery
    {
        ...
        public struct WorldMoverInput
        {
            ...
            /// <summary>
            /// The velocity used to calculate the <see cref="PhysicsQuery.WorldMoverInput.targetPosition"/>.
            ...
            /// The advantage of a separate filter to <see cref="PhysicsQuery.WorldMoverInput.overlapFilter"/> is that you can check for overlaps in a different way to what you can hit when moving.
            ...
            /// The maximum allowed iterations will not always be used and solving will cease if the iteration movement falls below the square of the <see cref="PhysicsQuery.WorldMoverInput.moveTolerance"/>.
            /// </summary>
            ...
            /// Too high a value will result in solving ceasing too quickly, too small will result in all allowed <see cref="PhysicsQuery.WorldMoverInput.maxIterations"/> being used.
            /// </summary>
            public float moveTolerance { readonly get => m_MoveTolerance; set => m_MoveTolerance = Mathf.Max(0.01f, value); }

            /// <summary>
            /// Whether to return all the individual <see cref="PhysicsShape.MoverCollision"/> results for all iterations or not.
            /// All the collisions will be returned in the <see cref="PhysicsQuery.WorldMoverResult"/> results.
            /// </summary>
        ...
        public struct QueryFilter
        {
            ...
            /// </summary>
            /// <param name="categories">A <see cref="PhysicsMask"/> defining the categories this query is using.</param>
            /// <param name="hitCategories">A <see cref="PhysicsMask"/> defining the categories this query will produce hits with.</param>
            /// <param name="ignoreFilter">A filter used to ignore items when filtering.</param>
            public QueryFilter(PhysicsMask categories, PhysicsMask hitCategories, PhysicsWorld.IgnoreFilter ignoreFilter = PhysicsWorld.IgnoreFilter.None)
            {
            ...
            /// <summary>
            /// The filter used to ignore items when filtering.
            /// </summary>
            public PhysicsWorld.IgnoreFilter ignoreFilter { readonly get => m_IgnoreFilter; set => m_IgnoreFilter = value;  }
            ...
            /// <summary>
            /// The default ignore filter used.
            /// </summary>
            public static readonly PhysicsWorld.IgnoreFilter DefaultIgnoreFilter = PhysicsWorld.IgnoreFilter.None;

            /// <summary>
            /// Get a query filter that is all categories, hits everything and doesn't ignore any objects.
            /// </summary>
            public static readonly QueryFilter Everything = new(PhysicsMask.All, PhysicsMask.All, PhysicsWorld.IgnoreFilter.None);

            /// <summary>
            /// Get the default query filter that hits everything.
            /// See <see cref="PhysicsQuery.QueryFilter.Everything"/>.
            /// </summary>
            public static readonly QueryFilter defaultFilter = Everything;

            #region Internal

            [SerializeField] internal PhysicsMask m_Categories;
            [SerializeField] internal PhysicsMask m_HitCategories;
            [SerializeField] internal PhysicsWorld.IgnoreFilter m_IgnoreFilter;
        ...
        public struct CastShapeInput
        {
            ...
            /// <summary>
            /// Create a CastShapeInput the specified <see cref="CircleGeometry"/>.
            /// You should transform the geometry into the space you require.
            /// </summary>
            ...
            /// <summary>
            /// Create a CastShapeInput the specified <see cref="CapsuleGeometry"/>.
            /// You should transform the geometry into the space you require.
            /// </summary>
            ...
            /// <summary>
            /// Create a CastShapeInput the specified <see cref="SegmentGeometry"/>.
            /// You should transform the geometry into the space you require.
            /// </summary>
            ...
            /// <summary>
            /// Create a CastShapeInput the specified <see cref="PolygonGeometry"/>.
            /// You should transform the geometry into the space you require.
            /// </summary>
            ...
            /// <summary>
            /// Create a CastShapeInput the specified <see cref="ChainSegmentGeometry"/>.
            /// You should transform the geometry into the space you require.
            /// </summary>
        ...
        public readonly partial struct CastResult
        {
            ...
            /// The surface normal at the point of contact.
            /// In all non-overlapped cases, this will be a unit-normal.
            /// If there was an initial overlap, the normal will be zero (degenerate) along with the <see cref="PhysicsQuery.CastResult.fraction"/> being zero.
            /// </summary>
            public readonly Vector2 normal => m_Normal;
            ...
            /// Check if the result is valid.
            /// </summary>
            public readonly bool isValid => m_IsValid;

            /// <summary>
            /// Implicitly convert the cast output to a bool using the value in the <see cref="PhysicsQuery.CastResult.isValid"/> flag.
            /// </summary>
