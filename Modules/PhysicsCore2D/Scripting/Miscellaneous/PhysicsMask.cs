...
namespace Unity.U2D.Physics
{
    ...
    public struct PhysicsMask : IEnumerable<int>
    {
        ...
        /// This uses <see cref="PhysicsMask.ResetBitIterator"/>.
        /// </summary>
        ...
        /// The bits are returned in ascending bit-index order.
        /// This uses <see cref="PhysicsMask.SetBitIterator"/>.
        /// </summary>
        ...
        /// <returns>The bit-wise operation using both BitMasks.</returns>
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        ...
        /// <summary>
        /// An iterator that will iterate only the bits that are reset (0) in a <see cref="PhysicsMask"/>
        /// </summary>
        ...
        /// <summary>
        /// An iterator that will iterate only the bits that are set (1) in a <see cref="PhysicsMask"/>
        /// </summary>
        ...
        /// <summary>
        /// When applied to a field/property of type <see cref="PhysicsMask"/>, the field/property drawer will not be display it as <see cref="PhysicsLayers"/>.
        ...
        /// This is only used when physics layers are active (see <see cref="PhysicsCoreSettings2D.usePhysicsLayers"/>).
        /// </summary>
